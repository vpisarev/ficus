...
fun init_std_names(): void {
    ...
    std_fx_free_rrbvec = gen_std_fun("fx_rrb_free", [:: make_ptr(std_CTypAnyRRBVec)], CTypVoid)
    std_fx_copy_rrbvec = gen_std_fun("fx_rrb_copy", [:: make_const_ptr(std_CTypAnyRRBVec), make_ptr(std_CTypAnyRRBVec)], CTypVoid)
    std_fx_make_rrbvec = gen_std_fun("fx_rrb_make", [:: CTypInt, CTypSize_t, std_CTypVoidPtr,
                std_CTypVoidPtr, std_CTypConstVoidPtr, make_ptr(std_CTypAnyArray)], CTypCInt)
    std_FX_FREE_VEC = gen_std_macro("FX_FREE_VEC", 1)
    std_fx_free_vec = gen_std_fun("fx_free_vec", [:: make_ptr(std_CTypAnyVec)], CTypVoid)
    std_fx_make_vec = gen_std_fun("fx_make_vec", [:: CTypInt, CTypInt, CTypSize_t, std_CTypVoidPtr,
                std_CTypVoidPtr, std_CTypConstVoidPtr, make_ptr(std_CTypAnyVec)], CTypCInt)
