...
FX_EXTERN_C_VAL(struct _fx_Nt6option1FPN9Ast__id_t2N9Ast__id_tR17C_form__c_callb_t_data_t* _fx_g6None9_)
FX_EXTERN_C_VAL(struct _fx_Nt6option1FPN14C_form__ctyp_t2N14C_form__ctyp_tR17C_form__c_callb_t_data_t* _fx_g6None8_)
FX_EXTERN_C_VAL(struct _fx_Nt6option1FPN14C_form__cexp_t2N14C_form__cexp_tR17C_form__c_callb_t_data_t* _fx_g6None7_)
   ...
   void* fx_fv)
{
   ...
   _fx_FPN15C_form__cstmt_t2N15C_form__cstmt_tR17C_form__c_callb_t adjust_cstmt_0 = {  };
   ...
   _fx_make_R17C_form__c_callb_t(_fx_g6None9_, _fx_g6None8_, _fx_g6None7_, v_0, &adjust_callb_0);
   ...
   void* fx_fv)
{
   ...
   *local_decls_1 = 0;
   ...
   if (v_0 == 0) {
      ...
      _fx_F5link2LN15C_form__cstmt_t2LN15C_form__cstmt_tLN15C_form__cstmt_t(v_1, sseq_1, &sseq_2, 0);
...
static int _fx_M19C_post_adjust_declsFM12adjust_cstmtN15C_form__cstmt_t2N15C_form__cstmt_tR17C_form__c_callb_t(
   ...
   void* fx_fv)
{
   _fx_FPLN15C_form__cstmt_t2LN15C_form__cstmt_tR17C_form__c_callb_t adjust_sseq_0 = {  };
   int fx_status = 0;
   ...
   if (tag_0 == _FX_N15C_form__cstmt_t_CDefVal) {
      ...
      if (v_0->tag == _FX_Nt6option_Some) {
         ...
         bool t_1;
         if (*local_have_ops_0) {
            if (FX_REC_VARIANT_TAG(t_0) == _FX_N14C_form__ctyp_t_CTypRawArray) {
               t_1 = false;
            }
            else {
               t_1 = true;
         ...
         if (t_1) {
            ...
            FX_CALL(
               _fx_M6C_formFM7CDefValN15C_form__cstmt_t4N14C_form__ctyp_tN9Ast__id_tNt6option1N14C_form__cexp_tR10Ast__loc_t(
                  t_0, n_0, &_fx_g7None11_, loc_0, &v_1), _fx_catch_0);
            FX_CALL(_fx_cons_LN15C_form__cstmt_t(v_1, *local_decls_0, true, &v_2), _fx_catch_0);
            _fx_free_LN15C_form__cstmt_t(local_decls_0);
            FX_COPY_PTR(v_2, local_decls_0);
            _fx_make_T2N14C_form__ctyp_tR10Ast__loc_t(t_0, loc_0, &v_3);
            FX_CALL(_fx_M6C_formFM9CExpIdentN14C_form__cexp_t2N9Ast__id_tT2N14C_form__ctyp_tR10Ast__loc_t(n_0, &v_3, &v_4),
               _fx_catch_0);
            _fx_make_T2N14C_form__ctyp_tR10Ast__loc_t(_fx_g16C_form__CTypVoid, loc_0, &v_5);
            FX_CALL(
               _fx_M6C_formFM10CExpBinaryN14C_form__cexp_t4N17C_form__cbinary_tN14C_form__cexp_tN14C_form__cexp_tT2N14C_form__ctyp_tR10Ast__loc_t(
                  &_fx_g17C_form__COpAssign, v_4, v_0->u.Some, &v_5, &v_6), _fx_catch_0);
            FX_CALL(_fx_M6C_formFM4CExpN15C_form__cstmt_t1N14C_form__cexp_t(v_6, fx_result), _fx_catch_0);
   ...
   if (tag_0 == _FX_N15C_form__cstmt_t_CDefForwardSym) {
      res_0 = true; goto _fx_endmatch_0;
   }
   if (tag_0 == _FX_N15C_form__cstmt_t_CDefForwardTyp) {
      res_0 = true; goto _fx_endmatch_0;
   }
   if (tag_0 == _FX_N15C_form__cstmt_t_CDefTyp) {
      res_0 = true; goto _fx_endmatch_0;
   }
   if (tag_0 == _FX_N15C_form__cstmt_t_CDefEnum) {
      res_0 = true; goto _fx_endmatch_0;
   }
   if (tag_0 == _FX_N15C_form__cstmt_t_CMacroDef) {
      res_0 = true; goto _fx_endmatch_0;
   }
   if (tag_0 == _FX_N15C_form__cstmt_t_CMacroUndef) {
      res_0 = true; goto _fx_endmatch_0;
   }
   if (tag_0 == _FX_N15C_form__cstmt_t_CMacroIf) {
      res_0 = true; goto _fx_endmatch_0;
   }
   if (tag_0 == _FX_N15C_form__cstmt_t_CMacroInclude) {
      res_0 = true; goto _fx_endmatch_0;
   }
   ...
   if (tag_0 == _FX_N15C_form__cstmt_t_CExp) {
      if (FX_REC_VARIANT_TAG(s_0->u.CExp) == _FX_N14C_form__cexp_t_CExpCCode) {
         res_0 = true; goto _fx_endmatch_0;
      }
   }
   res_0 = false;
...
_fx_endmatch_0: ;
   ...
   *local_have_ops_0 = true;
   if (FX_REC_VARIANT_TAG(s_0) == _FX_N15C_form__cstmt_t_CStmtBlock) {
