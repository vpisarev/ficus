...
static _fx_N14C_form__ctyp_t_data_t CTypLabel_data_0 = { 1, 23 };
_fx_N14C_form__ctyp_t _fx_g17C_form__CTypLabel = &CTypLabel_data_0;
static _fx_N14C_form__ctyp_t_data_t CTypAny_data_0 = { 1, 24 };
...
_fx_N14C_form__ctyp_t _fx_g25C_form__std_CTypAnyRRBVec = 0;
_fx_N14C_form__ctyp_t _fx_g22C_form__std_CTypAnyVec = 0;
...
_fx_R9Ast__id_t _fx_g26C_form__std_fx_free_rrbvec;
_fx_R9Ast__id_t _fx_g26C_form__std_fx_copy_rrbvec;
_fx_R9Ast__id_t _fx_g26C_form__std_fx_make_rrbvec;
...
FX_EXTERN_C int _fx_M6C_formFM9walk_ctypN14C_form__ctyp_t2N14C_form__ctyp_tRM9c_callb_t(
   struct _fx_N14C_form__ctyp_t_data_t*,
   struct _fx_R17C_form__c_callb_t*,
   struct _fx_N14C_form__ctyp_t_data_t**,
   void*);
...
static int _fx_M6C_formFM14walk_ctyp_opt_Nt6option1N14C_form__ctyp_t2Nt6option1N14C_form__ctyp_tRM9c_callb_t(
   struct _fx_Nt6option1N14C_form__ctyp_t*,
   struct _fx_R17C_form__c_callb_t*,
   struct _fx_Nt6option1N14C_form__ctyp_t*,
   void*);
...
static int _fx_M6C_formFM8walk_id_R9Ast__id_t1R9Ast__id_t(struct _fx_R9Ast__id_t*, struct _fx_R9Ast__id_t*, void*);
...
static int _fx_M6C_formFM11fold_cstmt_v1N15C_form__cstmt_t(struct _fx_N15C_form__cstmt_t_data_t*, void*);
...
static int _fx_M6C_formFM8fold_id_v1R9Ast__id_t(struct _fx_R9Ast__id_t*, void*);
   ...
   struct _fx_N14C_form__ctyp_t_data_t** fx_result)
{
   FX_MAKE_RECURSIVE_VARIANT_IMPL_START(_fx_N14C_form__ctyp_t);
   v->tag = 20;
   FX_COPY_PTR(arg0, &v->u.CTypRRBVec);
   return 0;
}
   ...
   void* fx_fv)
{
   ...
   fx_vec_t v_1 = *FX_PTR_1D(fx_vec_t, _fx_g16C_form__all_idcs, m_0);
   FX_VEC_CHKIDX(v_1, j_0, _fx_cleanup);
   _fx_copy_N15C_form__cinfo_t(&FX_VEC_ELEM(_fx_N15C_form__cinfo_t, v_1, j_0), fx_result);
   ...
   void* fx_fv)
{
   ...
   fx_vec_t v_1 = *FX_PTR_1D(fx_vec_t, _fx_g16C_form__all_idcs, m_0);
   FX_VEC_CHKIDX(v_1, j_0, _fx_cleanup);
   _fx_N15C_form__cinfo_t* v_2 = &FX_VEC_ELEM(_fx_N15C_form__cinfo_t, v_1, j_0);
   _fx_free_N15C_form__cinfo_t(v_2);
   _fx_copy_N15C_form__cinfo_t(entry_0, v_2);
...
FX_EXTERN_C int _fx_M6C_formFM13init_all_idcsv0(void* fx_fv)
{
   ...
   fx_vec_t* ptr_all_idks_0 = FX_PTR_1D(fx_vec_t, _fx_g16K_form__all_idks, 0);
   {
   ...
   void* fx_fv)
{
   ...
   fx_vec_t v_1 = *FX_PTR_1D(fx_vec_t, _fx_g16C_form__all_idcs, m_0);
   FX_VEC_CHKIDX(v_1, j_0, _fx_cleanup);
   _fx_copy_N15C_form__cinfo_t(&FX_VEC_ELEM(_fx_N15C_form__cinfo_t, v_1, j_0), &info_0);
   if (info_0.tag == 2) {
      ...
      if (!f_0) {
         ...
         if (tag_0 == 1) {
            ...
            _fx_R17C_form__cdeffun_t v_5 = {0};
            _fx_copy_R17C_form__cdeffun_t(&info_0.u.CFun->data, &v_5);
            loc_1 = v_5.cf_loc;
            _fx_free_R17C_form__cdeffun_t(&v_5);
         }
         else if (tag_0 == 4) {
            _fx_R17C_form__cdeftyp_t v_6 = {0};
            _fx_copy_R17C_form__cdeftyp_t(&info_0.u.CTyp->data, &v_6);
            loc_1 = v_6.ct_loc;
            _fx_free_R17C_form__cdeftyp_t(&v_6);
         }
         else if (tag_0 == 5) {
            _fx_R17C_form__cdefexn_t v_7 = {0};
            _fx_copy_R17C_form__cdefexn_t(&info_0.u.CExn->data, &v_7);
            loc_1 = v_7.cexn_loc;
            _fx_free_R17C_form__cdefexn_t(&v_7);
         }
         else if (tag_0 == 7) {
            _fx_R18C_form__cdefenum_t v_8 = {0};
            _fx_copy_R18C_form__cdefenum_t(&info_0.u.CEnum->data, &v_8);
            loc_1 = v_8.cenum_loc;
            _fx_free_R18C_form__cdefenum_t(&v_8);
         }
         else if (tag_0 == 6) {
            _fx_R23C_form__cdefinterface_t v_9 = {0};
            _fx_copy_R23C_form__cdefinterface_t(&info_0.u.CInterface->data, &v_9);
            loc_1 = v_9.ci_loc;
            ...
            _fx_R19C_form__cdefmacro_t v_10 = {0};
            _fx_copy_R19C_form__cdefmacro_t(&info_0.u.CMacro->data, &v_10);
            loc_1 = v_10.cm_loc;
   ...
   void* fx_fv)
{
   ...
   if (i_0->m == 0) {
      ...
      int_ j_0 = v_1.t1;
      FX_CHKIDX(FX_CHKIDX1(_fx_g16C_form__all_idcs, 0, m_0), _fx_cleanup);
      fx_vec_t v_2 = *FX_PTR_1D(fx_vec_t, _fx_g16C_form__all_idcs, m_0);
      FX_VEC_CHKIDX(v_2, j_0, _fx_cleanup);
      _fx_copy_N15C_form__cinfo_t(&FX_VEC_ELEM(_fx_N15C_form__cinfo_t, v_2, j_0), &v_0);
      int tag_0 = v_0.tag;
      if (tag_0 == 1) {
         ...
         _fx_R17C_form__cdeffun_t v_3 = {0};
         _fx_copy_R17C_form__cdeffun_t(&v_0.u.CFun->data, &v_3);
         fx_copy_str(&v_3.cf_cname, fx_result);
         _fx_free_R17C_form__cdeffun_t(&v_3);
      }
      else if (tag_0 == 4) {
         _fx_R17C_form__cdeftyp_t v_4 = {0};
         _fx_copy_R17C_form__cdeftyp_t(&v_0.u.CTyp->data, &v_4);
         fx_copy_str(&v_4.ct_cname, fx_result);
         _fx_free_R17C_form__cdeftyp_t(&v_4);
      }
      else if (tag_0 == 8) {
         fx_copy_str(&v_0.u.CLabel.cl_cname, fx_result);
      }
      else if (tag_0 == 7) {
         _fx_R18C_form__cdefenum_t v_5 = {0};
         _fx_copy_R18C_form__cdefenum_t(&v_0.u.CEnum->data, &v_5);
         fx_copy_str(&v_5.cenum_cname, fx_result);
         _fx_free_R18C_form__cdefenum_t(&v_5);
      }
      else if (tag_0 == 5) {
         _fx_R17C_form__cdefexn_t v_6 = {0};
         _fx_copy_R17C_form__cdefexn_t(&v_0.u.CExn->data, &v_6);
         fx_copy_str(&v_6.cexn_cname, fx_result);
         _fx_free_R17C_form__cdefexn_t(&v_6);
      }
      else if (tag_0 == 6) {
         _fx_R23C_form__cdefinterface_t v_7 = {0};
         _fx_copy_R23C_form__cdefinterface_t(&v_0.u.CInterface->data, &v_7);
         fx_copy_str(&v_7.ci_cname, fx_result);
         _fx_free_R23C_form__cdefinterface_t(&v_7);
      }
      else if (tag_0 == 9) {
         _fx_R19C_form__cdefmacro_t v_8 = {0};
         _fx_copy_R19C_form__cdefmacro_t(&v_0.u.CMacro->data, &v_8);
         fx_copy_str(&v_8.cm_cname, fx_result);
         _fx_free_R19C_form__cdefmacro_t(&v_8);
      }
      else {
         FX_FAST_THROW(FX_EXN_NoMatchError, _fx_cleanup);
      }
   ...
   void* fx_fv)
{
   ...
   _fx_catch_0: ;
      ...
      fx_vec_t v_7 = *FX_PTR_1D(fx_vec_t, _fx_g16C_form__all_idcs, m_0);
      FX_VEC_CHKIDX(v_7, j_0, _fx_catch_1);
      _fx_N15C_form__cinfo_t* v_8 = &FX_VEC_ELEM(_fx_N15C_form__cinfo_t, v_7, j_0);
      _fx_free_N15C_form__cinfo_t(v_8);
      _fx_copy_N15C_form__cinfo_t(&v_1, v_8);
   ...
   void* fx_fv)
{
   ...
   int_ j_0 = v_4.t1;
   FX_CHKIDX(FX_CHKIDX1(_fx_g16C_form__all_idcs, 0, m_0), _fx_cleanup);
   fx_vec_t v_5 = *FX_PTR_1D(fx_vec_t, _fx_g16C_form__all_idcs, m_0);
   FX_VEC_CHKIDX(v_5, j_0, _fx_cleanup);
   _fx_N15C_form__cinfo_t* v_6 = &FX_VEC_ELEM(_fx_N15C_form__cinfo_t, v_5, j_0);
   _fx_free_N15C_form__cinfo_t(v_6);
   _fx_copy_N15C_form__cinfo_t(&v_3, v_6);
   ...
   void* fx_fv)
{
   ...
   _fx_LN15C_form__cstmt_t res_1 = 0;
   ...
   for (; lst_1; lst_1 = lst_1->tl) {
      ...
      _fx_R10Ast__loc_t res_2;
      FX_CALL(_fx_M6C_formFM13get_cstmt_locR10Ast__loc_t1N15C_form__cstmt_t(x_1, &res_2, 0), _fx_catch_2);
      _fx_LR10Ast__loc_t node_1 = 0;
      FX_CALL(_fx_cons_LR10Ast__loc_t(&res_2, 0, false, &node_1), _fx_catch_2);
   ...
   for (; lst_2; lst_2 = lst_2->tl) {
      ...
      FX_CALL(_fx_cons_LN15C_form__cstmt_t(a_0, res_1, true, &v_3), _fx_catch_3);
      _fx_free_LN15C_form__cstmt_t(&res_1);
   ...
   void* fx_fv)
{
   ...
   if (tag_0 == 20) {
      ...
      FX_CALL(_fx_M6C_formFM10walk_ctyp_N14C_form__ctyp_t2N14C_form__ctyp_tRM9c_callb_t(t_0->u.CTypRRBVec, callb_0, &v_17, 0),
         _fx_catch_13);
      FX_CALL(_fx_M6C_formFM10CTypRRBVecN14C_form__ctyp_t1N14C_form__ctyp_t(v_17, fx_result), _fx_catch_13);
   ...
   if (tag_0 == 21) {
      ...
      FX_CALL(_fx_M6C_formFM10walk_ctyp_N14C_form__ctyp_t2N14C_form__ctyp_tRM9c_callb_t(t_0->u.CTypVector, callb_0, &v_18, 0),
         _fx_catch_14);
      FX_CALL(_fx_M6C_formFM10CTypVectorN14C_form__ctyp_t1N14C_form__ctyp_t(v_18, fx_result), _fx_catch_14);
   ...
   if (tag_0 == 17) {
      ...
      FX_CALL(_fx_M6C_formFM10walk_ctyp_N14C_form__ctyp_t2N14C_form__ctyp_tRM9c_callb_t(vcase_4->t1, callb_0, &v_19, 0),
         _fx_catch_15);
      FX_CALL(
         _fx_M6C_formFM10CTypRawPtrN14C_form__ctyp_t2LN19C_form__ctyp_attr_tN14C_form__ctyp_t(vcase_4->t0, v_19, fx_result),
         _fx_catch_15);
   ...
   if (tag_0 == 18) {
      ...
      FX_CALL(_fx_M6C_formFM10walk_ctyp_N14C_form__ctyp_t2N14C_form__ctyp_tRM9c_callb_t(vcase_5->t1, callb_0, &v_20, 0),
         _fx_catch_16);
      FX_CALL(
         _fx_M6C_formFM12CTypRawArrayN14C_form__ctyp_t2LN19C_form__ctyp_attr_tN14C_form__ctyp_t(vcase_5->t0, v_20, fx_result),
         _fx_catch_16);
   ...
   if (tag_0 == 22) {
      _fx_Nt6option1FPR9Ast__id_t2R9Ast__id_tR17C_form__c_callb_t v_21 = 0;
      _fx_R9Ast__id_t* n_4 = &t_0->u.CTypName;
      FX_COPY_PTR(callb_0->ccb_ident, &v_21);
      _fx_R9Ast__id_t v_22;
      if ((v_21 != 0) + 1 == 2) {
         _fx_FPR9Ast__id_t2R9Ast__id_tR17C_form__c_callb_t* f_4 = &v_21->u.Some;
         FX_CALL(f_4->fp(n_4, callb_0, &v_22, f_4->fcv), _fx_catch_17);
      ...
      FX_CALL(_fx_M6C_formFM8CTypNameN14C_form__ctyp_t1R9Ast__id_t(&v_22, fx_result), _fx_catch_18);

   _fx_catch_18: ;
      if (v_21) {
         _fx_free_Nt6option1FPR9Ast__id_t2R9Ast__id_tR17C_form__c_callb_t(&v_21);
      }
      goto _fx_endmatch_0;
   }
   if (tag_0 == 23) {
   ...
   void* fx_fv)
{
   ...
   if (tag_0 == 20) {
      FX_CALL(_fx_M6C_formFM10fold_ctyp_v2N14C_form__ctyp_tRM14c_fold_callb_t(t_0->u.CTypRRBVec, callb_0, 0), _fx_catch_15);

   _fx_catch_15: ;
      goto _fx_endmatch_0;
   }
   if (tag_0 == 21) {
      FX_CALL(_fx_M6C_formFM10fold_ctyp_v2N14C_form__ctyp_tRM14c_fold_callb_t(t_0->u.CTypVector, callb_0, 0), _fx_catch_16);
   ...
   if (tag_0 == 22) {
      ...
      if ((v_4 != 0) + 1 == 2) {
         ...
         FX_CALL(f_4->fp(&t_0->u.CTypName, callb_0, f_4->fcv), _fx_catch_17);
   ...
   void* fx_fv)
{
   ...
   if (tag_0 == 21) {
      fx_str_t slit_33 = FX_MAKE_STR("fx_vec_t");
      _fx_make_T2SR9Ast__id_t(&slit_33, &_fx_g9Ast__noid, fx_result);
      goto _fx_endmatch_0;
   }
   if (tag_0 == 22) {
      fx_str_t cname_0 = {0};
   ...
   void* fx_fv)
{
   ...
   if (FX_STR_LENGTH(cname_0) != 0) {
      ...
      fx_copy_str(&FX_VEC_ELEM(fx_str_t, _fx_g14Ast__all_names, v_2), fx_result);
   }
   else {
      int_ v_3 = n_0->i;
   ...
   void* fx_fv)
{
   ...
   if (i_0->m == 0) {
      ...
      int_ j_0 = v_2.t1;
      FX_CHKIDX(FX_CHKIDX1(_fx_g16C_form__all_idcs, 0, m_0), _fx_cleanup);
      fx_vec_t v_3 = *FX_PTR_1D(fx_vec_t, _fx_g16C_form__all_idcs, m_0);
      FX_VEC_CHKIDX(v_3, j_0, _fx_cleanup);
      _fx_copy_N15C_form__cinfo_t(&FX_VEC_ELEM(_fx_N15C_form__cinfo_t, v_3, j_0), &v_0);
      FX_CALL(
   ...
   void* fx_fv)
{
   ...
   if (f_0->m == 0) {
      ...
      int_ j_0 = v_3.t1;
      FX_CHKIDX(FX_CHKIDX1(_fx_g16C_form__all_idcs, 0, m_0), _fx_cleanup);
      fx_vec_t v_4 = *FX_PTR_1D(fx_vec_t, _fx_g16C_form__all_idcs, m_0);
      FX_VEC_CHKIDX(v_4, j_0, _fx_cleanup);
      _fx_copy_N15C_form__cinfo_t(&FX_VEC_ELEM(_fx_N15C_form__cinfo_t, v_4, j_0), &v_0);
      FX_CALL(
...
FX_EXTERN_C int fx_init_C_form(void)
{
   ...
   FX_CALL(
      ...
      _fx_cleanup);
   FX_CALL(
      _fx_M6C_formFM10CTypRRBVecN14C_form__ctyp_t1N14C_form__ctyp_t(_fx_g15C_form__CTypAny, &_fx_g25C_form__std_CTypAnyRRBVec),
      _fx_cleanup);
   FX_CALL(
      _fx_M6C_formFM10CTypVectorN14C_form__ctyp_t1N14C_form__ctyp_t(_fx_g15C_form__CTypAny, &_fx_g22C_form__std_CTypAnyVec),
      _fx_cleanup);
   ...
   _fx_g26C_form__std_fx_free_rrbvec = _fx_g9Ast__noid;
   _fx_g26C_form__std_fx_copy_rrbvec = _fx_g9Ast__noid;
   _fx_g26C_form__std_fx_make_rrbvec = _fx_g9Ast__noid;
...
FX_EXTERN_C void fx_deinit_C_form(void)
{
   ...
   if (_fx_g25C_form__std_CTypAnyRRBVec) {
      _fx_free_N14C_form__ctyp_t(&_fx_g25C_form__std_CTypAnyRRBVec);
   }
   if (_fx_g22C_form__std_CTypAnyVec) {
      _fx_free_N14C_form__ctyp_t(&_fx_g22C_form__std_CTypAnyVec);
   }
