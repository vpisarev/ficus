   ...
   void* fx_fv)
{
   ...
   if (tag_0 == 3) {
      ...
      _fx_T4N17C_form__cbinary_tN14C_form__cexp_tN14C_form__cexp_tT2N14C_form__ctyp_tR10Ast__loc_t* vcase_3 =
         &e_0->u.CExpBinary;
      _fx_N14C_form__cexp_t b_0 = vcase_3->t2;
      _fx_N14C_form__cexp_t a_0 = vcase_3->t1;
      ...
      FX_CALL(_fx_M4C_ppFM8pp_cexp_v3R5PP__tN14C_form__cexp_ti(pp_0, a_0, a_pr_1, 0), _fx_catch_8);
      FX_CALL(_fx_M2PPFM5spacev1RM1t(pp_0, 0), _fx_catch_8);
      FX_CALL(_fx_M2PPFM3strv2RM1tS(pp_0, &bop_str_0, 0), _fx_catch_8);
      FX_CALL(_fx_M2PPFM5spacev1RM1t(pp_0, 0), _fx_catch_8);
      FX_CALL(_fx_M4C_ppFM8pp_cexp_v3R5PP__tN14C_form__cexp_ti(pp_0, b_0, b_pr_1, 0), _fx_catch_8);
      if (use_br_0) {
         FX_CALL(_fx_M2PPFM3cutv1RM1t(pp_0, 0), _fx_catch_8);
         fx_str_t slit_7 = FX_MAKE_STR(")");
