...
FX_EXTERN_C_VAL(struct _fx_Nt6option1FPv2N14C_form__ctyp_tR22C_form__c_fold_callb_t_data_t* _fx_g6None4_)
   ...
   void* fx_fv)
{
   ...
   _fx_make_R22C_form__c_fold_callb_t(_fx_g6None5_, _fx_g6None4_, _fx_g6None3_, v_2, &rename_callb_0);
