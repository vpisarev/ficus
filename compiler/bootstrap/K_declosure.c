   ...
   void* fx_fv)
{
   ...
   for (int_ i_0 = 0; i_0 < v_1; i_0++) {
      ...
      if (tidx_0 >= 2) {
         ...
         _fx_copy_Rt20Hashmap__hashentry_t2R9Ast__id_tLR9Ast__id_t(
            FX_PTR_1D(_fx_Rt20Hashmap__hashentry_t2R9Ast__id_tLR9Ast__id_t, self_0->u.t.t5, v_2), &entry_0);
         bool t_0;
         if (entry_0.hv == hv_0) {
   ...
   void* fx_fv)
{
   ...
   if (self_0->u.t.t1 + 1 > idxsz_0 >> 1) {
      ...
      FX_CALL(
         _fx_M11K_declosureFM4growv2Nt10Hashmap__t2R9Ast__id_tLR9Ast__id_ti(self_0, fx_maxi(idxsz_0 / 2, self_0->u.t.t1 + 1),
            0), _fx_cleanup);
   }
   uint64_t perturb_0 = hv_0;
   int_ found_0 = -1;
   ...
   for (int_ i_0 = 0; i_0 < v_5; i_0++) {
      ...
      if (tidx_0 >= 2) {
         ...
         _fx_copy_Rt20Hashmap__hashentry_t2R9Ast__id_tLR9Ast__id_t(
            FX_PTR_1D(_fx_Rt20Hashmap__hashentry_t2R9Ast__id_tLR9Ast__id_t, self_0->u.t.t5, v_6), &entry_0);
         bool t_0;
         if (entry_0.hv == hv_0) {
   ...
   void* fx_fv)
{
   ...
   if (self_0->u.t.t1 + 1 > idxsz_0 >> 1) {
      ...
      FX_CALL(
         _fx_M11K_declosureFM4growv2Nt10Hashmap__t2R9Ast__id_tR9Ast__id_ti(self_0, fx_maxi(idxsz_0 / 2, self_0->u.t.t1 + 1), 0),
         _fx_cleanup);
   }
   uint64_t perturb_0 = hv_0;
   int_ found_0 = -1;
