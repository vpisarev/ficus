...
static int _fx_M4K_ppFM7pp_exp_v2N14K_form__kexp_tR5PP__t(struct _fx_N14K_form__kexp_t_data_t*, struct _fx_R5PP__t*, void*);
...
static int _fx_M4K_ppFM5ppktpv2Nt6option1R17K_form__ktprops_tR5PP__t(
   struct _fx_Nt6option1R17K_form__ktprops_t*,
   struct _fx_R5PP__t*,
   void*);
...
FX_EXTERN_C int _fx_M3AstFM6stringS1N15Ast__for_make_t(struct _fx_N15Ast__for_make_t*, fx_str_t*, void*);
...
_fx_endmatch_0: ;
   ...
   if (tag_1 == 5) {
      ...
      fx_str_t v_5 = {0};
      fx_exn_t v_6 = {0};
      FX_CALL(_fx_F6stringS1i(t_0->u.KTypFloat, &v_4, 0), _fx_catch_9);
      fx_str_t slit_9 = FX_MAKE_STR("K_pp: invalid type TypFloat(");
      fx_str_t slit_10 = FX_MAKE_STR(")");
      {
         const fx_str_t strs_2[] = { slit_9, v_4, slit_10 };
         FX_CALL(fx_strjoin(0, 0, 0, strs_2, 3, &v_5), _fx_catch_9);
      }
      FX_CALL(_fx_M3AstFM11compile_errE3RM5loc_tSLS(loc_0, &v_5, 0, &v_6, 0), _fx_catch_9);
      FX_THROW(&v_6, false, _fx_catch_9);
   ...
   if (tag_1 == 13) {
      ...
      FX_CALL(_fx_M6K_formFM9KTypTupleN14K_form__ktyp_t1LN14K_form__ktyp_t(tl_0, &v_7), _fx_catch_16);
      FX_CALL(_fx_M4K_ppFM7ppktyp_v4N14K_form__ktyp_tiR10Ast__loc_tR5PP__t(v_7, prec_0, loc_0, pp_0, 0), _fx_catch_16);
   ...
   _fx_endmatch_1: ;
      ...
      FX_CALL(_fx_M2PPFM5spacev1RM1t(pp_0, 0), _fx_catch_17);
      FX_CALL(_fx_M4K_ppFM7ppktyp_v4N14K_form__ktyp_tiR10Ast__loc_tR5PP__t(vcase_0->t1, prec_0, loc_0, pp_0, 0), _fx_catch_17);
   ...
   if (tag_1 == 20) {
      ...
      FX_CALL(
         _fx_M4K_ppFM9ppktypsufv6N14K_form__ktyp_tSR10Ast__loc_tiR5PP__ti(t_0->u.KTypList, &slit_19, loc_0, p1_0, pp_0, prec_0,
            0), _fx_catch_18);
   ...
   if (tag_1 == 19) {
      ...
      FX_CALL(
         _fx_M4K_ppFM9ppktypsufv6N14K_form__ktyp_tSR10Ast__loc_tiR5PP__ti(t_0->u.KTypVector, &slit_21, loc_0, p1_0, pp_0,
            prec_0, 0), _fx_catch_20);
   ...
   if (tag_1 == 21) {
      ...
      FX_CALL(
         _fx_M4K_ppFM9ppktypsufv6N14K_form__ktyp_tSR10Ast__loc_tiR5PP__ti(t_0->u.KTypRef, &slit_22, loc_0, p1_0, pp_0, prec_0,
            0), _fx_catch_21);
   ...
   if (tag_1 == 17) {
      ...
      FX_CALL(_fx_F7__mul__S2Ci((char_)44, vcase_1->t0 - 1, &v_8, 0), _fx_catch_22);
      fx_str_t slit_23 = FX_MAKE_STR("[");
      fx_str_t slit_24 = FX_MAKE_STR("]");
      {
         const fx_str_t strs_3[] = { slit_23, v_8, slit_24 };
         FX_CALL(fx_strjoin(0, 0, 0, strs_3, 3, &v_9), _fx_catch_22);
      }
   ...
   if (tag_1 == 16) {
      fx_str_t v_10 = {0};
      FX_CALL(_fx_M6K_formFM7idk2strS2R9Ast__id_tR10Ast__loc_t(&t_0->u.KTypName, loc_0, &v_10, 0), _fx_catch_23);
      FX_CALL(_fx_M2PPFM3strv2RM1tS(pp_0, &v_10, 0), _fx_catch_23);
   ...
   if (tag_1 == 14) {
      ...
      FX_CALL(_fx_M4K_ppFM11ppktyplist_v4SLN14K_form__ktyp_tR10Ast__loc_tR5PP__t(&slit_25, t_0->u.KTypTuple, loc_0, pp_0, 0),
         _fx_catch_24);
   ...
   if (tag_1 == 15) {
      ...
      FX_CALL(_fx_M6K_formFM7idk2strS2R9Ast__id_tR10Ast__loc_t(&vcase_2->t0, loc_0, &v_11, 0), _fx_catch_26);
      FX_CALL(_fx_M2PPFM3strv2RM1tS(pp_0, &v_11, 0), _fx_catch_26);
      if (detailed_0) {
         fx_str_t slit_26 = FX_MAKE_STR(" {");
         FX_CALL(_fx_M2PPFM3strv2RM1tS(pp_0, &slit_26, 0), _fx_catch_26);
         int_ i_0 = 0;
         ...
         for (; lst_0; lst_0 = lst_0->tl, i_0 += 1) {
            ...
            if (i_0 != 0) {
               ...
               FX_CALL(_fx_M2PPFM3strv2RM1tS(pp_0, &slit_27, 0), _fx_catch_25);
               FX_CALL(_fx_M2PPFM5spacev1RM1t(pp_0, 0), _fx_catch_25);
            }
            FX_CALL(_fx_M6K_formFM7idk2strS2R9Ast__id_tR10Ast__loc_t(&ni_0, loc_0, &v_12, 0), _fx_catch_25);
            FX_CALL(_fx_M2PPFM3strv2RM1tS(pp_0, &v_12, 0), _fx_catch_25);
            fx_str_t slit_28 = FX_MAKE_STR(": ");
            FX_CALL(_fx_M2PPFM3strv2RM1tS(pp_0, &slit_28, 0), _fx_catch_25);
            FX_CALL(_fx_M4K_ppFM7ppktyp_v4N14K_form__ktyp_tiR10Ast__loc_tR5PP__t(ti_0, 0, loc_0, pp_0, 0), _fx_catch_25);
   ...
   if (tag_1 == 23) {
      fx_str_t slit_31 = FX_MAKE_STR("<err>");
   ...
   if (tag_1 == 11) {
      fx_str_t slit_32 = FX_MAKE_STR("cptr");
   ...
   if (tag_1 == 12) {
      ...
      FX_CALL(
         _fx_M4K_ppFM9ppktypsufv6N14K_form__ktyp_tSR10Ast__loc_tiR5PP__ti(t_0->u.KTypRawPointer, &slit_33, loc_0, p1_0, pp_0,
            prec_0, 0), _fx_catch_30);

   _fx_catch_30: ;
      goto _fx_endmatch_2;
   }
   if (tag_1 == 24) {
      fx_str_t slit_34 = FX_MAKE_STR("module");
   ...
   void* fx_fv)
{
   ...
   if (tag_0 == 15) {
      ...
      if (tag_1 == 15) {
         ...
         FX_CALL(_fx_M3AstFM11compile_errE3RM5loc_tSLS(loc_0, &v_34, 0, &v_35, 0), _fx_catch_37);
      ...
      _fx_catch_38: ;
         ...
         FX_CALL(_fx_M3AstFM11compile_errE3RM5loc_tSLS(loc_0, &v_37, 0, &v_38, 0), _fx_catch_39);
   ...
   if (tag_0 == 13) {
      ...
      if (v_40.tag == 2) {
         ...
         _fx_R23K_form__kdefinterface_t* v_44 = &v_40.u.Some->data;
         FX_COPY_PTR(v_44->ki_all_methods, &v_42);
      ...
      _fx_catch_50: ;
         ...
         FX_CALL(_fx_M3AstFM11compile_errE3RM5loc_tSLS(loc_1, &slit_81, 0, &v_45, 0), _fx_catch_51);
         FX_THROW(&v_45, false, _fx_catch_51);
   ...
   if (tag_0 == 19) {
      ...
      FX_CALL(_fx_M3AstFM10border2strS2N13Ast__border_tB(&vcase_15->t1, true, &v_46, 0), _fx_catch_54);
      FX_CALL(_fx_M2PPFM3strv2RM1tS(pp_0, &v_46, 0), _fx_catch_54);
      FX_CALL(_fx_M3AstFM10interp2strS2N18Ast__interpolate_tB(&vcase_15->t2, true, &v_47, 0), _fx_catch_54);
      FX_CALL(_fx_M2PPFM3strv2RM1tS(pp_0, &v_47, 0), _fx_catch_54);
   ...
   if (tag_0 == 27) {
      ...
      FX_CALL(_fx_M6K_formFM7KExpNopN14K_form__kexp_t1R10Ast__loc_t(&vcase_18->t4, &v_48), _fx_catch_58);
      FX_CALL(
         _fx_M4K_ppFM11pp_for_hdr_v5N14K_form__kexp_tLT2R9Ast__id_tN13K_form__dom_tLR9Ast__id_tR10Ast__loc_tR5PP__t(v_48,
   ...
   if (tag_0 == 26) {
      ...
      _fx_N15Ast__for_make_t v_50 = flags_0->for_flag_make;
      int tag_3 = v_50.tag;
      if (tag_3 == 3) {
         fx_str_t slit_90 = FX_MAKE_STR("["); fx_str_t slit_91 = FX_MAKE_STR("]"); _fx_make_Ta2S(&slit_90, &slit_91, &v_49);
      }
      else if (tag_3 == 2) {
         fx_str_t slit_92 = FX_MAKE_STR("["); fx_str_t slit_93 = FX_MAKE_STR("]"); _fx_make_Ta2S(&slit_92, &slit_93, &v_49);
      }
      else if (tag_3 == 4) {
         fx_str_t slit_94 = FX_MAKE_STR("["); fx_str_t slit_95 = FX_MAKE_STR("]"); _fx_make_Ta2S(&slit_94, &slit_95, &v_49);
      }
      else if (tag_3 == 5) {
         fx_str_t slit_96 = FX_MAKE_STR("["); fx_str_t slit_97 = FX_MAKE_STR("]"); _fx_make_Ta2S(&slit_96, &slit_97, &v_49);
      }
      else if (tag_3 == 6) {
         fx_str_t slit_98 = FX_MAKE_STR("("); fx_str_t slit_99 = FX_MAKE_STR(")"); _fx_make_Ta2S(&slit_98, &slit_99, &v_49);
      }
      else {
         fx_str_t v_51 = {0};
         fx_str_t v_52 = {0};
         fx_exn_t v_53 = {0};
         _fx_N15Ast__for_make_t v_54 = flags_0->for_flag_make;
         FX_CALL(_fx_M3AstFM6stringS1N15Ast__for_make_t(&v_54, &v_51, 0), _fx_catch_59);
         fx_str_t slit_100 = FX_MAKE_STR("unsupported type of comprehension \'");
         fx_str_t slit_101 = FX_MAKE_STR("\'");
         {
            const fx_str_t strs_3[] = { slit_100, v_51, slit_101 };
            FX_CALL(fx_strjoin(0, 0, 0, strs_3, 3, &v_52), _fx_catch_59);
         }
         FX_CALL(_fx_M3AstFM11compile_errE3RM5loc_tSLS(&vcase_19->t3.t1, &v_52, 0, &v_53, 0), _fx_catch_59);
         FX_THROW(&v_53, false, _fx_catch_59);
      ...
      fx_copy_str(&v_49.t0, &begin_0);
      fx_copy_str(&v_49.t1, &end_0);
   ...
   if (tag_0 == 22) {
      ...
      for (; lst_16; lst_16 = lst_16->tl, i_10 += 1) {
         ...
         if (i_10 == 0) {
            fx_str_t slit_102 = FX_MAKE_STR("if "); fx_copy_str(&slit_102, &v_55);
         }
         else if (checks_i_0 == 0) {
            fx_str_t slit_103 = FX_MAKE_STR("else"); fx_copy_str(&slit_103, &v_55);
         }
         else {
            fx_str_t slit_104 = FX_MAKE_STR("else if "); fx_copy_str(&slit_104, &v_55);
         }
         FX_CALL(_fx_M2PPFM3strv2RM1tS(pp_0, &v_55, 0), _fx_catch_63);
         int_ j_3 = 0;
