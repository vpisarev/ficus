...
static void _fx_copy_T3LSiB(_fx_T3LSiB* src,
                            _fx_T3LSiB* dst)
{
...
static void _fx_make_T3LSiB(struct _fx_LS_data_t* t0,
                            int_ t1,
                            bool t2,
                            _fx_T3LSiB* fx_result)
{
...
static void _fx_copy_T2LSi(_fx_T2LSi* src,
                           _fx_T2LSi* dst)
{
   FX_COPY_PTR(src->t0, &dst->t0);
   dst->t1 = src->t1;
...
static void _fx_make_T2LSi(struct _fx_LS_data_t* t0,
                           int_ t1,
                           _fx_T2LSi* fx_result)
{
   FX_COPY_PTR(t0, &fx_result->t0);
...
{
   int fx_status = 0;
   *fx_result = _fx_F6lengthi1S(s_0, 0);
   return fx_status;
}
...
FX_EXTERN_C int_ _fx_M6StringFM5rfindi3SCi(fx_str_t* s,
                                           char_ c,
                                           int_ from_pos,
                                           void* fx_fv)
{
                                          ...
                                          void* fx_fv)
{
   ...
   for (int_ i_0 = 0; i_0 < len_0; i_0++) {
      ...
      bool sep_0 = v_3.t2;
      if (ci_0 == c_0) {
         if (sep_0) FX_COPY_PTR(sl_1, &v_5);
         else {
            FX_CALL(fx_substr(s_0, start_0, i_0, 1, 0, &v_6), _fx_catch_0);
            FX_CALL(_fx_cons_LS(&v_6, sl_1, true, &v_5), _fx_catch_0);
         }
         _fx_make_T3LSiB(v_5, start_0, true, &v_4);
      }
      else { int_ t_0; if (sep_0) t_0 = i_0; else t_0 = start_0; _fx_make_T3LSiB(sl_1, t_0, false, &v_4);
      }
...
FX_EXTERN_C int _fx_M6StringFM10num_suffixS1i(int_ n_0,
                                              fx_str_t* fx_result,
                                              void* fx_fv)
{
   int fx_status = 0;
