   ...
   void* fx_fv)
{
   ...
   for (;;) {
      ...
      if (tag_0 == 13) {
         ...
         FX_COPY_PTR(result_24, &result_25);
         ...
         _fx_free_LS(&result_1);
         FX_COPY_PTR(result_25, &result_1);
      ...
      if (tag_0 == 14) {
         ...
         if (elems_0 != 0) {
            ...
            if (__fold_result___0) {
               ...
               FX_CALL(_fx_cons_LS(&nstr_0, v_15, true, &result_26), _fx_catch_27);
