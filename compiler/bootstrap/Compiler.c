...
FX_EXTERN_C int _fx_M6ParserFM19dump_generics_sitesv0(void*);
      ...
      _fx_catch_9: ;
         ...
         if (fx_status < 0) {
            ...
            if (tag_0 == _FX_EXN_E22LexerUtils__LexerError) {
               ...
               FX_CALL(_fx_F6stringS1i(v_21->t0, &v_18, 0), _fx_catch_10);
               FX_CALL(_fx_F6stringS1i(v_21->t1, &v_19, 0), _fx_catch_10);
               fx_str_t slit_0 = FX_MAKE_STR(":");
               fx_str_t slit_1 = FX_MAKE_STR(":");
            ...
            _fx_catch_10: ;
               ...
               FX_CALL(_fx_M3AstFM6stringS1RM5loc_t(loc_0, &v_22, 0), _fx_catch_11);
               FX_CALL(_fx_M3AstFM11loc_excerptS1RM5loc_t(loc_0, &v_23, 0), _fx_catch_11);
               fx_str_t slit_5 = FX_MAKE_STR(": error: ");
               fx_str_t* msg_1 = &vcase_1->t1;
               fx_str_t slit_6 = FX_MAKE_STR("\n");
               {
                  const fx_str_t strs_1[] = { v_22, slit_5, *msg_1, v_23, slit_6 };
                  FX_CALL(fx_strjoin(0, 0, 0, strs_1, 5, &v_24), _fx_catch_11);
               }
            ...
            _fx_catch_11: ;
               ...
               {
                  const fx_str_t strs_2[] = { mfname_0, slit_8, v_25, slit_9 };
...
FX_EXTERN_C int _fx_M8CompilerFM11process_allB1S(fx_str_t* fname0_0, bool* fx_result, void* fx_fv)
{
   ...
   bool v_29 = _fx_g12Options__opt.print_generics_sites;
   if (v_29) {
      FX_CALL(_fx_M6ParserFM19dump_generics_sitesv0(0), _fx_catch_6);
   }
   _fx_LS lstend_1 = 0;
   ...
   for (; lst_1; lst_1 = lst_1->tl) {
      ...
      FX_CALL(_fx_M3AstFM15get_module_nameRM4id_t1i(m_idx_0, &v_30, 0), _fx_catch_2);
      FX_CALL(_fx_M3AstFM2ppS1RM4id_t(&v_30, &res_0, 0), _fx_catch_2);
      _fx_LS node_1 = 0;
   ...
   if (ok_1) {
      ...
      bool v_31 = _fx_g12Options__opt.print_ast;
      if (v_31) {
   ...
   if (ok_2) {
      ...
      bool v_32 = _fx_g12Options__opt.print_k0;
      if (v_32) {
   ...
   if (nwarns_0 != 0) {
      ...
      bool v_38 = _fx_g12Options__opt.Werror;
      if (v_38) {
   ...
   if (ok_4) {
      ...
      if (_fx_g12Options__opt.Werror) {
         v_39 = _fx_g22Ast__all_compile_warns > 0;
      }
      else {
         v_39 = false;
      }
   ...
   if (fx_status < 0) {
      ...
      if (tag_0 == _FX_EXN_E4Fail) {
         ...
         fx_str_t* msg_0 = &FX_EXN_DATA(_fx_E4Fail_data_t, exn_0.data);
         {
            ...
            FX_CALL(fx_strjoin(0, 0, 0, strs_4, 3, &v_40), _fx_catch_7);
         }
         _fx_F12print_stringv1S(&v_40, 0);
      ...
      _fx_catch_7: ;
         ...
         fx_str_t v_41 = {0};
         fx_str_t v_42 = {0};
         FX_CALL(_fx_F6stringS1E(&exn_0, &v_41, 0), _fx_catch_9);
         fx_str_t slit_34 =
            FX_MAKE_STR("\n"
               U"\n");
         ...
         {
            const fx_str_t strs_5[] = { slit_34, _fx_g15Compiler__error, slit_35, v_41, slit_36 };
            FX_CALL(fx_strjoin(0, 0, 0, strs_5, 5, &v_42), _fx_catch_9);
         }
