...
typedef struct _fx_Ta2LN14Lexer__token_t {
   struct _fx_LN14Lexer__token_t_data_t* t0;
   struct _fx_LN14Lexer__token_t_data_t* t1;
} _fx_Ta2LN14Lexer__token_t;
...
static void _fx_free_Ta2LN14Lexer__token_t(struct _fx_Ta2LN14Lexer__token_t* dst)
{
   _fx_free_LN14Lexer__token_t(&dst->t0);
   _fx_free_LN14Lexer__token_t(&dst->t1);
}

static void _fx_copy_Ta2LN14Lexer__token_t(struct _fx_Ta2LN14Lexer__token_t* src, struct _fx_Ta2LN14Lexer__token_t* dst)
{
   FX_COPY_PTR(src->t0, &dst->t0);
   FX_COPY_PTR(src->t1, &dst->t1);
}

static void _fx_make_Ta2LN14Lexer__token_t(
   struct _fx_LN14Lexer__token_t_data_t* t0,
   struct _fx_LN14Lexer__token_t_data_t* t1,
   struct _fx_Ta2LN14Lexer__token_t* fx_result)
{
   FX_COPY_PTR(t0, &fx_result->t0);
   FX_COPY_PTR(t1, &fx_result->t1);
}
...
_fx_N14Lexer__token_t _fx_g19Compiler__SEMICOLON = { 54 };
_fx_N14Lexer__token_t _fx_g19Compiler__PP_DEFINE = { 102 };
...
FX_EXTERN_C int _fx_M3SysFM6getenvS2SS(fx_str_t*, fx_str_t*, fx_str_t*, void*);

FX_EXTERN_C int _fx_M3SysFM9colortermB0(bool*, void*);
...
FX_EXTERN_C void _fx_M5LexerFM6IMPORTN14Lexer__token_t1B(bool, struct _fx_N14Lexer__token_t*);

FX_EXTERN_C void _fx_M5LexerFM4STARN14Lexer__token_t1B(bool, struct _fx_N14Lexer__token_t*);
...
FX_EXTERN_C int _fx_M3SysFM7getpathLS1S(fx_str_t*, struct _fx_LS_data_t**, void*);
...
FX_EXTERN_C int _fx_M8FilenameFM6existsB1S(fx_str_t*, bool*, void*);

FX_EXTERN_C int _fx_M3AstFM6get_idRM4id_t1S(fx_str_t*, struct _fx_R9Ast__id_t*, void*);

FX_EXTERN_C int _fx_M3AstFM11find_modulei2RM4id_tS(struct _fx_R9Ast__id_t*, fx_str_t*, int_*, void*);

FX_EXTERN_C_VAL(fx_arr_t _fx_g16Ast__all_modules)
FX_EXTERN_C int _fx_M6ParserFM5parseB3iLN14Lexer__token_tLS(
   int_,
   struct _fx_LN14Lexer__token_t_data_t*,
...
FX_EXTERN_C int _fx_M3AstFM19diag_format_is_jsonB0(bool*, void*);

FX_EXTERN_C int _fx_M3AstFM15emit_error_jsonv2RM5loc_tS(struct _fx_R10Ast__loc_t*, fx_str_t*, void*);
...
static int _fx_M8CompilerFM3dfsv5iLiA1LiA1BrLi(
   int_,
   struct _fx_Li_data_t*,
   fx_arr_t*,
   fx_arr_t*,
   struct _fx_rLi_data_t*,
   void*);
...
FX_EXTERN_C int _fx_M3AstFM10pr_verbosev1S(fx_str_t*, void*);

FX_EXTERN_C int _fx_M7OptionsFM18force_full_rebuildv0(void*);

FX_EXTERN_C int _fx_M4FileFM10write_utf8v2SS(fx_str_t*, fx_str_t*, void*);

FX_EXTERN_C int _fx_M8K_mangleFM12mangle_mnameS1S(fx_str_t*, fx_str_t*, void*);

FX_EXTERN_C int _fx_M4K_ppFM16pp_top_to_stringS1LN14K_form__kexp_t(struct _fx_LN14K_form__kexp_t_data_t*, fx_str_t*, void*);

FX_EXTERN_C int _fx_M3SysFM6removev1S(fx_str_t*, void*);
...
FX_EXTERN_C int _fx_M3SysFM6getenvS1S(fx_str_t*, fx_str_t*, void*);
...
FX_EXTERN_C int _fx_M4FileFM18pclose_exit_statusi1RM1t(struct _fx_R7File__t*, int_*, void*);
...
FX_EXTERN_C int _fx_M13Ast_typecheckFM9check_modv1i(int_, void*);

FX_EXTERN_C int _fx_M6K_formFM13init_all_idksv0(void*);
...
FX_EXTERN_C int _fx_M4K_ppFM8pp_kmodsv1LR17K_form__kmodule_t(struct _fx_LR17K_form__kmodule_t_data_t*, void*);

FX_EXTERN_C int _fx_M6C_formFM13init_all_idcsv0(void*);

FX_EXTERN_C int _fx_M9C_gen_stdFM14init_std_namesv0(void*);

FX_EXTERN_C int _fx_M10C_gen_codeFM13gen_ccode_allLR17C_form__cmodule_t1LR17K_form__kmodule_t(
   struct _fx_LR17K_form__kmodule_t_data_t*,
   struct _fx_LR17C_form__cmodule_t_data_t**,
   void*);
   ...
   for (;;) {
      ...
      if (lo_2 + 1 < hi_2) {
         ...
         for (int_ j_0 = 0; j_0 < n_0; j_0++) {
            ...
            if (v_10) {
               _fx_M8CompilerFM6_swap_v3A1Eii(arr_0, i0_0, j_1, 0); i0_0 = i0_0 + 1;
            }
         ...
         fx_copy_exn(FX_PTR_1D(fx_exn_t, *arr_0, i0_0), &a_1);
         FX_CHKIDX(FX_CHKIDX1(*arr_0, 0, hi_2), _fx_catch_2);
         fx_exn_t* v_11 = FX_PTR_1D(fx_exn_t, *arr_0, hi_2);
         fx_free_exn(v_11);
         fx_copy_exn(&a_1, v_11);
         FX_CHKIDX(FX_CHKIDX1(*arr_0, 0, i0_0), _fx_catch_2);
         fx_exn_t* v_12 = FX_PTR_1D(fx_exn_t, *arr_0, i0_0);
         fx_free_exn(v_12);
         fx_copy_exn(&p_1, v_12);
         int_ i1_0 = hi_2;
         ...
         for (int_ j_2 = 0; j_2 < n_1; j_2++) {
            ...
            fx_copy_exn(FX_PTR_1D(fx_exn_t, *arr_0, v_14), &v_13);
            bool v_15;
         ...
         if (i0_0 - lo_2 < hi_2 - i1_0) {
            ...
            FX_CALL(_fx_M8CompilerFM6qsort_v5iiA1EFPB2EEi(lo_2, i0_0 - 1, arr_0, lt_0, prefix_0, 0), _fx_catch_2);
            if (i1_0 < prefix_0) {
         ...
         if (v_16) {
            FX_CHKIDX(FX_CHKIDX1(*arr_0, 0, hi_2), _fx_catch_2);
            fx_exn_t* v_17 = FX_PTR_1D(fx_exn_t, *arr_0, hi_2);
            fx_free_exn(v_17);
            fx_copy_exn(&a_2, v_17);
            FX_CHKIDX(FX_CHKIDX1(*arr_0, 0, lo_2), _fx_catch_2);
            fx_exn_t* v_18 = FX_PTR_1D(fx_exn_t, *arr_0, lo_2);
            fx_free_exn(v_18);
            fx_copy_exn(&b_1, v_18);
            FX_BREAK(_fx_catch_2);
         }
         else {
            FX_BREAK(_fx_catch_2);
...
FX_EXTERN_C int _fx_M8CompilerFM3revLS1LS(struct _fx_LS_data_t* l_0, struct _fx_LS_data_t** fx_result, void* fx_fv)
{
   ...
   for (; lst_0; lst_0 = lst_0->tl) {
      ...
      FX_CALL(_fx_cons_LS(a_0, res_0, true, &v_0), _fx_catch_0);
      _fx_free_LS(&res_0);
...
FX_EXTERN_C int _fx_M8CompilerFM4growv2Nt10Hashset__t1Si(struct _fx_Nt10Hashset__t1S_data_t* hs_0, int_ new_size_0, void* fx_fv)
{
   ...
   void* fx_fv)
{
   ...
   if (hs_0->u.t.t1 + 1 > idxsz_0 >> 1) {
      ...
      FX_CALL(_fx_M8CompilerFM4growv2Nt10Hashset__t1Si(hs_0, fx_maxi(idxsz_0 / 2, hs_0->u.t.t1 + 1), 0), _fx_cleanup);
   }
   uint64_t perturb_0 = hv_0;
   int_ found_0 = -1;
   int_ insert_idx_0 = -1;
...
FX_EXTERN_C int _fx_M8CompilerFM4listLS1Nt10Hashset__t1S(
   struct _fx_Nt10Hashset__t1S_data_t* hs_0,
   struct _fx_LS_data_t** fx_result,
   void* fx_fv)
{
   ...
   for (int_ j_0 = 0; j_0 < v_0; j_0++) {
      FX_CHKIDX(FX_CHKIDX1(hs_0->u.t.t5, 0, j_0), _fx_catch_0);
      _fx_Rt24Hashset__hashset_entry_t1S* v_1 = FX_PTR_1D(_fx_Rt24Hashset__hashset_entry_t1S, hs_0->u.t.t5, j_0);
      if (v_1->hv >= 9223372036854775808ULL) {
         FX_CONTINUE(_fx_catch_0);
      }
      FX_CHKIDX(FX_CHKIDX1(hs_0->u.t.t5, 0, j_0), _fx_catch_0);
      _fx_Rt24Hashset__hashset_entry_t1S* v_2 = FX_PTR_1D(_fx_Rt24Hashset__hashset_entry_t1S, hs_0->u.t.t5, j_0);
      _fx_LS node_0 = 0;
      FX_CALL(_fx_cons_LS(&v_2->key, 0, false, &node_0), _fx_catch_0);
...
FX_EXTERN_C int _fx_M8CompilerFM11build_stampS0(fx_str_t* fx_result, void* fx_fv)
{
   _fx_R18Options__options_t o_0 = {0};
   _fx_LT2SN17Options__optval_t v_0 = 0;
   _fx_LS v_1 = 0;
   fx_str_t defs_0 = {0};
   fx_str_t env_cflags_0 = {0};
   fx_str_t v_2 = {0};
   fx_str_t v_3 = {0};
   fx_str_t v_4 = {0};
   fx_str_t v_5 = {0};
   ...
   fx_str_t v_7 = {0};
   fx_str_t v_8 = {0};
   fx_str_t opt_sig_0 = {0};
   fx_str_t v_9 = {0};
   int fx_status = 0;
   _fx_copy_R18Options__options_t(&_fx_g12Options__opt, &o_0);
   FX_COPY_PTR(o_0.defines, &v_0);
   _fx_LS lstend_0 = 0;
   _fx_LT2SN17Options__optval_t lst_0 = v_0;
   for (; lst_0; lst_0 = lst_0->tl) {
      fx_str_t n_0 = {0};
      _fx_N17Options__optval_t v_10 = {0};
      fx_str_t vs_0 = {0};
      fx_str_t concat_str_0 = {0};
      _fx_T2SN17Options__optval_t* __pat___0 = &lst_0->hd;
      fx_copy_str(&__pat___0->t0, &n_0);
      _fx_copy_N17Options__optval_t(&__pat___0->t1, &v_10);
      int tag_0 = v_10.tag;
      if (tag_0 == 1) {
         FX_CALL(_fx_F6stringS1B(v_10.u.OptBool, &vs_0, 0), _fx_catch_0);  _fx_catch_0: ;
      }
      else if (tag_0 == 2) {
         FX_CALL(_fx_F6stringS1i(v_10.u.OptInt, &vs_0, 0), _fx_catch_1);  _fx_catch_1: ;
      }
      else if (tag_0 == 3) {
         fx_copy_str(&v_10.u.OptString, &vs_0);
      }
      else {
      ...
      {
         const fx_str_t strs_0[] = { n_0, slit_0, vs_0 };
         FX_CALL(fx_strjoin(0, 0, 0, strs_0, 3, &concat_str_0), _fx_catch_2);
      }
      _fx_LS node_0 = 0;
      FX_CALL(_fx_cons_LS(&concat_str_0, 0, false, &node_0), _fx_catch_2);
      FX_LIST_APPEND(v_1, lstend_0, node_0);

   _fx_catch_2: ;
      FX_FREE_STR(&concat_str_0);
      FX_FREE_STR(&vs_0);
      _fx_free_N17Options__optval_t(&v_10);
      FX_FREE_STR(&n_0);
      FX_CHECK_EXN(_fx_cleanup);
   }
   fx_str_t slit_1 = FX_MAKE_STR(";");
   FX_CALL(_fx_F4joinS2SLS(&slit_1, v_1, &defs_0, 0), _fx_cleanup);
   fx_str_t slit_2 = FX_MAKE_STR("FICUS_CFLAGS");
   fx_str_t slit_3 = FX_MAKE_STR("");
   FX_CALL(_fx_M3SysFM6getenvS2SS(&slit_2, &slit_3, &env_cflags_0, 0), _fx_cleanup);
   FX_CALL(_fx_F6stringS1i(o_0.optimize_level, &v_2, 0), _fx_cleanup);
   FX_CALL(_fx_F6stringS1B(o_0.enable_openmp, &v_3, 0), _fx_cleanup);
   FX_CALL(_fx_F6stringS1B(o_0.compile_by_cpp, &v_4, 0), _fx_cleanup);
   FX_CALL(_fx_F6stringS1B(o_0.debug, &v_5, 0), _fx_cleanup);
   FX_CALL(_fx_F6stringS1i(o_0.inline_thresh, &v_6, 0), _fx_cleanup);
   FX_CALL(_fx_F6stringS1i(o_0.optim_iters, &v_7, 0), _fx_cleanup);
   fx_copy_str(&o_0.cflags, &v_8);
   fx_str_t slit_4 = FX_MAKE_STR("O");
   fx_str_t slit_5 = FX_MAKE_STR(" omp=");
   fx_str_t slit_6 = FX_MAKE_STR(" cpp=");
   fx_str_t slit_7 = FX_MAKE_STR(" dbg=");
   fx_str_t slit_8 = FX_MAKE_STR(" inl=");
   fx_str_t slit_9 = FX_MAKE_STR(" iters=");
   fx_str_t slit_10 = FX_MAKE_STR(" cflags=[");
   fx_str_t slit_11 = FX_MAKE_STR("] envcflags=[");
   fx_str_t slit_12 = FX_MAKE_STR("] defs=[");
   fx_str_t slit_13 = FX_MAKE_STR("]");
   {
      const fx_str_t strs_1[] =
         { slit_4, v_2, slit_5, v_3, slit_6, v_4, slit_7, v_5, slit_8, v_6, slit_9, v_7, slit_10, v_8, slit_11, env_cflags_0,
            slit_12, defs_0, slit_13 };
      FX_CALL(fx_strjoin(0, 0, 0, strs_1, 19, &opt_sig_0), _fx_cleanup);
   }
   FX_CALL(_fx_M8CompilerFM18compiler_signatureS0(&v_9, 0), _fx_cleanup);
   fx_str_t slit_14 = FX_MAKE_STR("\n");
   fx_str_t slit_15 = FX_MAKE_STR("\n");
   {
      const fx_str_t strs_2[] = { v_9, slit_14, opt_sig_0, slit_15 };
      FX_CALL(fx_strjoin(0, 0, 0, strs_2, 4, fx_result), _fx_cleanup);
   }

_fx_cleanup: ;
   _fx_free_R18Options__options_t(&o_0);
   if (v_0) {
      _fx_free_LT2SN17Options__optval_t(&v_0);
   }
   if (v_1) {
      _fx_free_LS(&v_1);
   }
   FX_FREE_STR(&defs_0);
   FX_FREE_STR(&env_cflags_0);
   FX_FREE_STR(&v_2);
   FX_FREE_STR(&v_3);
   FX_FREE_STR(&v_4);
   FX_FREE_STR(&v_5);
   ...
   void* fx_fv)
{
   ...
   if (v_12) {
      ...
      fx_str_t slit_2 = FX_MAKE_STR("Complex");
      _fx_make_T2SB(&slit_2, true, &v_3);
      fx_str_t slit_3 = FX_MAKE_STR("Array");
      _fx_make_T2SB(&slit_3, true, &v_4);
      fx_str_t slit_4 = FX_MAKE_STR("List");
   ...
   void* fx_fv)
{
   ...
   while (queue_0 != 0) {
      ...
      if (!minfo_0->u.defmodule_t.t7) {
         ...
         _fx_N16Ast__defmodule_t v_11 = *FX_PTR_1D(_fx_N16Ast__defmodule_t, _fx_g16Ast__all_modules, m_idx_1);
         v_11->u.defmodule_t.t7 = true;
         FX_CALL(_fx_M8FilenameFM7dirnameS1S(&mfname_0, &dir1_0, 0), _fx_catch_9);
         bool v_12 = _fx_F6__eq__B2SS(&dir1_0, &dir0_0, 0);
         if (!v_12) {
         ...
         if (v_8 == 0) {
            ...
            for (; lst_3; lst_3 = lst_3->tl) {
               ...
               FX_LIST_APPEND(v_13, lstend_3, node_3);

            _fx_catch_5: ;
               FX_CHECK_EXN(_fx_catch_6);
            }
            _fx_M8CompilerFM5link2LS2LSLS(v_13, inc_dirs0_3, &inc_dirs_0, 0);
         ...
         bool v_14;
         FX_CALL(_fx_M6ParserFM5parseB3iLN14Lexer__token_tLS(m_idx_1, preamble_0, inc_dirs_0, &v_14, 0), _fx_catch_9);
         ok_0 = (bool)(ok_0 & v_14);
         FX_CHKIDX(FX_CHKIDX1(_fx_g16Ast__all_modules, 0, m_idx_1), _fx_catch_9);
         _fx_N16Ast__defmodule_t v_15 = *FX_PTR_1D(_fx_N16Ast__defmodule_t, _fx_g16Ast__all_modules, m_idx_1);
         FX_COPY_PTR(v_15->u.defmodule_t.t5, &v_9);
         _fx_Li lst_4 = v_9;
         for (; lst_4; lst_4 = lst_4->tl) {
            _fx_Li v_16 = 0;
            int_ a_0 = lst_4->hd;
            FX_CALL(_fx_cons_Li(a_0, res_1, true, &v_16), _fx_catch_7);
         ...
         for (; lst_5; lst_5 = lst_5->tl) {
            ...
            if (!dep_minfo_0->u.defmodule_t.t7) {
               FX_CALL(_fx_cons_Li(dep_0, queue_0, true, &v_17), _fx_catch_8);
               FX_FREE_LIST_SIMPLE(&queue_0);
               FX_COPY_PTR(v_17, &queue_0);
            }
      ...
      _fx_catch_9: ;
         ...
         if (fx_status < 0) {
            ...
            if (tag_0 == _FX_EXN_E22LexerUtils__LexerError) {
               ...
               _fx_Ta2i* v_21 = &vcase_0->t0;
               int_ c_0 = v_21->t1;
               int_ l_0 = v_21->t0;
               bool v_22;
               FX_CALL(_fx_M3AstFM19diag_format_is_jsonB0(&v_22, 0), _fx_catch_10);
               if (v_22) {
                  _fx_R10Ast__loc_t v_23 = { m_idx_1, l_0, c_0, l_0, c_0 };
                  FX_CALL(_fx_M3AstFM15emit_error_jsonv2RM5loc_tS(&v_23, msg_0, 0), _fx_catch_10);
               }
               else {
                  FX_CALL(_fx_F6stringS1i(l_0, &v_18, 0), _fx_catch_10);
                  FX_CALL(_fx_F6stringS1i(c_0, &v_19, 0), _fx_catch_10);
                  fx_str_t slit_0 = FX_MAKE_STR(":");
                  fx_str_t slit_1 = FX_MAKE_STR(":");
                  fx_str_t slit_2 = FX_MAKE_STR(": error: ");
                  fx_str_t slit_3 = FX_MAKE_STR("\n");
                  {
                     const fx_str_t strs_0[] = { mfname_0, slit_0, v_18, slit_1, v_19, slit_2, *msg_0, slit_3 };
                     FX_CALL(fx_strjoin(0, 0, 0, strs_0, 8, &v_20), _fx_catch_10);
                  }
            ...
            _fx_catch_10: ;
               ...
               bool v_27;
               FX_CALL(_fx_M3AstFM19diag_format_is_jsonB0(&v_27, 0), _fx_catch_11);
               if (v_27) {
                  FX_CALL(_fx_M3AstFM15emit_error_jsonv2RM5loc_tS(loc_0, msg_1, 0), _fx_catch_11);
               }
               else {
                  FX_CALL(_fx_M3AstFM6stringS1RM5loc_t(loc_0, &v_24, 0), _fx_catch_11);
                  FX_CALL(_fx_M3AstFM11loc_excerptS1RM5loc_t(loc_0, &v_25, 0), _fx_catch_11);
                  fx_str_t slit_5 = FX_MAKE_STR(": error: ");
                  fx_str_t slit_6 = FX_MAKE_STR("\n");
                  {
                     const fx_str_t strs_1[] = { v_24, slit_5, *msg_1, v_25, slit_6 };
                     FX_CALL(fx_strjoin(0, 0, 0, strs_1, 5, &v_26), _fx_catch_11);
                  }
            ...
            _fx_catch_11: ;
               ...
               fx_str_t v_28 = {0};
               fx_str_t v_29 = {0};
               FX_CALL(_fx_F6stringS1E(&exn_0, &v_28, 0), _fx_catch_12);
               fx_str_t slit_8 = FX_MAKE_STR(": exception ");
               fx_str_t slit_9 = FX_MAKE_STR(" occured");
               {
                  const fx_str_t strs_2[] = { mfname_0, slit_8, v_28, slit_9 };
                  FX_CALL(fx_strjoin(0, 0, 0, strs_2, 4, &v_29), _fx_catch_12);
               }
   ...
   void* fx_fv)
{
   ...
   for (int_ i_1 = 0; i_1 < nvtx_0; i_1++) {
      ...
      bool v_0 = *FX_PTR_1D(bool, processed_0, i_1);
      if (v_0) {
         FX_CONTINUE(_fx_catch_0);
      }
   ...
   for (; lst_1; lst_1 = lst_1->tl) {
      _fx_Li v_1 = 0;
      int_ a_0 = lst_1->hd;
      FX_CALL(_fx_cons_Li(a_0, res_0, true, &v_1), _fx_catch_1);
   ...
   void* fx_fv)
{
   ...
   for (; lst_2; lst_2 = lst_2->tl) {
      ...
      bool v_5 = *FX_PTR_1D(bool, *processed_0, j_1);
      if (v_5) {
   ...
   bool* v_6 = FX_PTR_1D(bool, *processed_0, i_0);
   *v_6 = true;
   ...
   void* fx_fv)
{
   ...
   fx_str_t stamp_file_0 = {0};
   fx_str_t cur_stamp_0 = {0};
   fx_str_t old_stamp_0 = {0};
   fx_exn_t exn_0 = {0};
   fx_str_t v_0 = {0};
   fx_exn_t exn_1 = {0};
   ...
   int fx_status = 0;
   bool* dstptr_0 = 0;
   int_ v_2 = FX_ARR_SIZE(_fx_g16Ast__all_modules, 0);
   {
   ...
   for (int_ i_0 = 0; i_0 < v_2; i_0++, dstptr_0++) {
      *dstptr_0 = false;
   }
   ...
   fx_str_t slit_2 = FX_MAKE_STR(".fxstamp");
   FX_CALL(_fx_M8FilenameFM9normalizeS2SS(&build_dir_0, &slit_2, &stamp_file_0, 0), _fx_cleanup);
   FX_CALL(_fx_M8CompilerFM11build_stampS0(&cur_stamp_0, 0), _fx_cleanup);
   FX_CALL(_fx_M4FileFM9read_utf8S1S(&stamp_file_0, &old_stamp_0, 0), _fx_catch_0);

_fx_catch_0: ;
   if (fx_status < 0) {
      fx_exn_get_and_reset(fx_status, &exn_0);
      fx_status = 0;
      FX_FREE_STR(&old_stamp_0);
      int tag_0 = exn_0.tag;
      bool res_0;
      ...
      FX_CHECK_EXN(_fx_cleanup);
      if (res_0) {
         fx_str_t slit_3 = FX_MAKE_STR(""); fx_copy_str(&slit_3, &old_stamp_0); goto _fx_endmatch_0;
      }
   ...
   bool v_3 = _fx_F6__eq__B2SS(&cur_stamp_0, &old_stamp_0, 0);
   if (!v_3) {
      bool v_4 = _fx_g12Options__opt.force_rebuild;
      bool t_0;
      if (!v_4) {
         t_0 = FX_STR_LENGTH(old_stamp_0) != 0;
      }
      else {
         t_0 = false;
      }
      if (t_0) {
         if (_fx_g21Compiler__iscolorterm) {
            fx_str_t slit_4 = FX_MAKE_STR("[34;1mbuild stamp changed (compiler/mode) -> full rebuild[0m");
            fx_copy_str(&slit_4, &v_0);
         }
         else {
            fx_str_t slit_5 = FX_MAKE_STR("build stamp changed (compiler/mode) -> full rebuild"); fx_copy_str(&slit_5, &v_0);
         }
         FX_CALL(_fx_M3AstFM10pr_verbosev1S(&v_0, 0), _fx_cleanup);
      }
      FX_CALL(_fx_M7OptionsFM18force_full_rebuildv0(0), _fx_cleanup);
      FX_CALL(_fx_M4FileFM10write_utf8v2SS(&stamp_file_0, &cur_stamp_0, 0), _fx_catch_1);
   ...
   for (; lst_0; lst_0 = lst_0->tl) {
      ...
      if (is_cpp_0) {
         fx_str_t slit_6 = FX_MAKE_STR(".cpp"); fx_copy_str(&slit_6, &ext_0);
      }
      else {
         fx_str_t slit_7 = FX_MAKE_STR(".c"); fx_copy_str(&slit_7, &ext_0);
      }
      ...
      fx_str_t slit_8 = FX_MAKE_STR(".k");
      {
         const fx_str_t strs_0[] = { cname_0, slit_8 };
      ...
      if (v_8) {
         fx_str_t slit_9 = FX_MAKE_STR(""); fx_copy_str(&slit_9, &old_kform_0);
      }
      else {
         FX_CALL(_fx_M4FileFM9read_utf8S1S(&k_filename_0, &old_kform_0, 0), _fx_catch_2);
      ...
      _fx_catch_2: ;
         if (fx_status < 0) {
            ...
            int tag_2 = exn_2.tag;
            bool res_2;
            if (tag_2 == FX_EXN_IOError) {
               res_2 = true;
            }
            else if (tag_2 == FX_EXN_FileOpenError) {
               res_2 = true;
            }
            else {
               res_2 = false;
            ...
            FX_CHECK_EXN(_fx_catch_5);
            if (res_2) {
               fx_str_t slit_10 = FX_MAKE_STR(""); fx_copy_str(&slit_10, &old_kform_0); goto _fx_endmatch_2;
            }
            FX_RETHROW(&exn_2, _fx_catch_5);

         _fx_endmatch_2: ;
            FX_CHECK_EXN(_fx_catch_5);
         }
      }
      bool v_9 = _fx_F6__eq__B2SS(&new_kform_0, &old_kform_0, 0);
      if (v_9) {
         fx_str_t slit_11 = FX_MAKE_STR(""); _fx_make_T3BBS(true, true, &slit_11, &v_5);
      }
      else {
         bool well_written_0;
         FX_CALL(_fx_M4FileFM10write_utf8v2SS(&k_filename_0, &new_kform_0, 0), _fx_catch_3);
         well_written_0 = true;
      ...
      _fx_catch_3: ;
         if (fx_status < 0) {
            ...
            int tag_3 = exn_3.tag;
            bool res_3;
            if (tag_3 == FX_EXN_IOError) {
               res_3 = true;
            }
            else if (tag_3 == FX_EXN_FileOpenError) {
               res_3 = true;
            }
            else {
               res_3 = false;
            ...
            FX_CHECK_EXN(_fx_catch_5);
            if (res_3) {
               well_written_0 = false; goto _fx_endmatch_3;
            }
            FX_RETHROW(&exn_3, _fx_catch_5);

         _fx_endmatch_3: ;
            FX_CHECK_EXN(_fx_catch_5);
         }
         if (well_written_0) {
            fx_str_t slit_12 = FX_MAKE_STR(""); fx_copy_str(&slit_12, &v_6);
         }
         else if (_fx_g21Compiler__iscolorterm) {
            fx_str_t slit_13 = FX_MAKE_STR("[31;1mfailed to write .k[0m"); fx_copy_str(&slit_13, &v_6);
         }
         else {
            fx_str_t slit_14 = FX_MAKE_STR("failed to write .k"); fx_copy_str(&slit_14, &v_6);
         }
         _fx_make_T3BBS(well_written_0, false, &v_6, &v_5);
      }
      bool ok_j_0 = v_5.t0;
      bool same_kform_0 = v_5.t1;
      fx_copy_str(&v_5.t2, &status_j_0);
      ...
      if (same_kform_0) {
         ...
         for (; lst_1; lst_1 = lst_1->tl) {
            int_ d_0 = lst_1->hd;
            FX_CHKIDX(FX_CHKIDX1(skip_flags_0, 0, d_0), _fx_catch_4);
            bool v_10 = *FX_PTR_1D(bool, skip_flags_0, d_0);
            if (!v_10) {
      ...
      if (FX_STR_LENGTH(status_j_0) != 0) {
         ...
         fx_str_t slit_15 = FX_MAKE_STR("skip"); fx_copy_str(&slit_15, &status_j_1);
      }
      else if (_fx_g21Compiler__iscolorterm) {
         fx_str_t slit_16 = FX_MAKE_STR("[34;1mprocess[0m"); fx_copy_str(&slit_16, &status_j_1);
      }
      else {
      ...
      {
         const fx_str_t strs_3[] = { slit_18, km_cname_0, slit_19, status_j_1 };
         FX_CALL(fx_strjoin(0, 0, 0, strs_3, 4, &v_7), _fx_catch_5);
      }
      FX_CALL(_fx_M3AstFM10pr_verbosev1S(&v_7, 0), _fx_catch_5);
      FX_CHKIDX(FX_CHKIDX1(skip_flags_0, 0, km_idx_0), _fx_catch_5);
      bool* v_11 = FX_PTR_1D(bool, skip_flags_0, km_idx_0);
      *v_11 = skip_module_0;
   ...
   if (!ok_1) {
      fx_str_t slit_20 = FX_MAKE_STR("failed to write some k-forms");
      FX_CALL(_fx_F9make_FailE1S(&slit_20, &v_1), _fx_cleanup);
...
_fx_cleanup: ;
   ...
   FX_FREE_STR(&stamp_file_0);
   FX_FREE_STR(&cur_stamp_0);
   FX_FREE_STR(&old_stamp_0);
   fx_free_exn(&exn_0);
   FX_FREE_STR(&v_0);
   fx_free_exn(&exn_1);
   ...
   void* fx_fv)
{
   ...
   for (int_ i_0 = 0; i_0 < n_0; i_0++) {
      ...
      int_ v_32 = _fx_g12Options__opt.inline_thresh;
      if (v_32 > 0) {
   ...
   void* fx_fv)
{
   ...
   if (_fx_g10Sys__win32) {
      ...
      FX_CALL(_fx_M8CompilerFM4listLS1Nt10Hashset__t1S(_fx_g19Ast__all_c_inc_dirs, &v_2, 0), _fx_cleanup);
      _fx_LS lstend_0 = 0;
      _fx_LS lst_0 = v_2;
      for (; lst_0; lst_0 = lst_0->tl) {
         fx_str_t concat_str_0 = {0};
         ...
         {
            const fx_str_t strs_1[] = { slit_8, *d_0 };
            FX_CALL(fx_strjoin(0, 0, 0, strs_1, 2, &concat_str_0), _fx_catch_0);
         }
         _fx_LS node_0 = 0;
      ...
      FX_CALL(_fx_M8CompilerFM4joinS2SLS(&slit_9, v_3, &incdirs_0, 0), _fx_cleanup);
      FX_CALL(_fx_M8CompilerFM6stringS1S(&opt_flags_0, &v_4, 0), _fx_cleanup);
      fx_str_t slit_10 = FX_MAKE_STR("");
      FX_CALL(_fx_M8CompilerFM6stringS1S(&slit_10, &v_5, 0), _fx_cleanup);
      FX_CALL(_fx_M8CompilerFM6stringS1S(&incdirs_0, &v_6, 0), _fx_cleanup);
      FX_CALL(_fx_M8CompilerFM6stringS1S(&runtime_include_path_0, &v_7, 0), _fx_cleanup);
      fx_str_t slit_11 = FX_MAKE_STR("/utf-8 /nologo");
      fx_str_t slit_12 = FX_MAKE_STR(" ");
      fx_str_t slit_13 = FX_MAKE_STR(" /I");
      {
         const fx_str_t strs_2[] = { slit_11, v_4, v_5, slit_12, v_6, slit_13, v_7 };
      ...
      fx_str_t slit_21 = FX_MAKE_STR("/nologo /F10485760 kernel32.lib advapi32.lib");
      _fx_make_Ta9S(&slit_14, &slit_15, &slit_16, &slit_17, &slit_18, &slit_19, &slit_20, &cflags_0, &slit_21, &v_0);
   }
   else {
      fx_str_t slit_22 = FX_MAKE_STR("CC");
      fx_str_t slit_23 = FX_MAKE_STR("cc");
      FX_CALL(_fx_M3SysFM6getenvS2SS(&slit_22, &slit_23, &c_comp_0, 0), _fx_cleanup);
      fx_str_t slit_24 = FX_MAKE_STR("CXX");
      fx_str_t slit_25 = FX_MAKE_STR("c++");
      FX_CALL(_fx_M3SysFM6getenvS2SS(&slit_24, &slit_25, &cpp_comp_name_0, 0), _fx_cleanup);
      FX_CALL(_fx_M8CompilerFM6stringS1S(&cpp_comp_name_0, &v_8, 0), _fx_cleanup);
      fx_str_t slit_26 = FX_MAKE_STR(" -std=c++11");
      {
      ...
      FX_CALL(_fx_M8CompilerFM8containsB2SS(&osinfo_0, &slit_27, &v_48, 0), _fx_cleanup);
      if (v_48) {
         if (enable_openmp_0) {
            bool v_49;
            fx_str_t slit_28 = FX_MAKE_STR("gcc");
            FX_CALL(_fx_M8CompilerFM8containsB2SS(&c_comp_0, &slit_28, &v_49, 0), _fx_cleanup);
            if (v_49) {
               ...
               fx_str_t slit_31 = FX_MAKE_STR("-Xclang -fopenmp");
               fx_str_t slit_32 = FX_MAKE_STR(" -lomp");
               _fx_make_Ta2S(&slit_31, &slit_32, &v_10);
            }
         }
         else {
            fx_str_t slit_33 = FX_MAKE_STR(""); fx_str_t slit_34 = FX_MAKE_STR(""); _fx_make_Ta2S(&slit_33, &slit_34, &v_10);
         }
         fx_copy_str(&v_10.t0, &omp_cflags_0);
         fx_copy_str(&v_10.t1, &omp_lib_0);
         bool v_50;
         fx_str_t slit_35 = FX_MAKE_STR("x86_64");
         FX_CALL(_fx_M8CompilerFM8containsB2SS(&osinfo_0, &slit_35, &v_50, 0), _fx_cleanup);
         if (v_50) {
            fx_str_t slit_36 = FX_MAKE_STR(" ");
            {
               const fx_str_t strs_4[] = { slit_36, omp_cflags_0, omp_lib_0 };
               FX_CALL(fx_strjoin(0, 0, 0, strs_4, 3, &v_12), _fx_cleanup);
            }
            fx_str_t slit_37 = FX_MAKE_STR("macos_x64");
            _fx_make_Ta3S(&slit_37, &omp_cflags_0, &v_12, &v_11);
         }
         else {
            bool v_51;
            fx_str_t slit_38 = FX_MAKE_STR("arm64");
            FX_CALL(_fx_M8CompilerFM8containsB2SS(&osinfo_0, &slit_38, &v_51, 0), _fx_cleanup);
            if (v_51) {
               fx_str_t slit_39 = FX_MAKE_STR(" ");
               {
                  const fx_str_t strs_5[] = { slit_39, omp_cflags_0, omp_lib_0 };
                  FX_CALL(fx_strjoin(0, 0, 0, strs_5, 3, &v_13), _fx_cleanup);
               }
               fx_str_t slit_40 = FX_MAKE_STR("macos_arm64");
               _fx_make_Ta3S(&slit_40, &omp_cflags_0, &v_13, &v_11);
            }
            else {
               fx_str_t slit_41 = FX_MAKE_STR("");
               fx_str_t slit_42 = FX_MAKE_STR("");
               fx_str_t slit_43 = FX_MAKE_STR("");
               _fx_make_Ta3S(&slit_41, &slit_42, &slit_43, &v_11);
            }
         }
         fx_copy_str(&v_11.t0, &libpath_0);
         fx_copy_str(&v_11.t1, &cflags_1);
         fx_copy_str(&v_11.t2, &clibs_0);
         fx_str_t slit_44 = FX_MAKE_STR("macos");
         _fx_make_Ta4S(&slit_44, &libpath_0, &cflags_1, &clibs_0, &v_9);
      }
      else {
         bool v_52;
         fx_str_t slit_45 = FX_MAKE_STR("Linux");
         FX_CALL(_fx_M8CompilerFM8containsB2SS(&osinfo_0, &slit_45, &v_52, 0), _fx_cleanup);
         if (v_52) {
            if (enable_openmp_0) {
               fx_str_t slit_46 = FX_MAKE_STR(" -fopenmp"); fx_copy_str(&slit_46, &omp_flags_0);
            }
            else {
               fx_str_t slit_47 = FX_MAKE_STR(""); fx_copy_str(&slit_47, &omp_flags_0);
            }
            fx_str_t slit_48 = FX_MAKE_STR("linux");
            fx_str_t slit_49 = FX_MAKE_STR("");
            _fx_make_Ta4S(&slit_48, &slit_49, &omp_flags_0, &omp_flags_0, &v_9);
         }
         else if (_fx_g9Sys__unix) {
            fx_str_t slit_50 = FX_MAKE_STR("unix");
            fx_str_t slit_51 = FX_MAKE_STR("");
            fx_str_t slit_52 = FX_MAKE_STR("");
            fx_str_t slit_53 = FX_MAKE_STR("");
            _fx_make_Ta4S(&slit_50, &slit_51, &slit_52, &slit_53, &v_9);
         }
         else {
            ...
            _fx_make_Ta4S(&slit_54, &slit_55, &slit_56, &slit_57, &v_9);
         }
      }
      fx_copy_str(&v_9.t0, &os_0);
      fx_copy_str(&v_9.t1, &libpath_1);
      fx_copy_str(&v_9.t2, &cflags_2);
      fx_copy_str(&v_9.t3, &clibs_1);
      if (opt_level_0 == 0) {
         fx_str_t slit_58 = FX_MAKE_STR(" -D_DEBUG -ggdb"); fx_copy_str(&slit_58, &ggdb_opt_0);
      }
      else {
         if (opt_level_0 == 100) {
            fx_str_t slit_59 = FX_MAKE_STR(" -DFX_NO_STACK_OVERFLOW_CHECK"); fx_copy_str(&slit_59, &stk_overflow_0);
         }
         else {
            fx_str_t slit_60 = FX_MAKE_STR(""); fx_copy_str(&slit_60, &stk_overflow_0);
         }
         FX_CALL(_fx_M8CompilerFM6stringS1S(&stk_overflow_0, &v_14, 0), _fx_cleanup);
         fx_str_t slit_61 = FX_MAKE_STR(" -DNDEBUG");
         {
            const fx_str_t strs_6[] = { slit_61, v_14 };
            FX_CALL(fx_strjoin(0, 0, 0, strs_6, 2, &ggdb_opt_0), _fx_cleanup);
         }
      }
      FX_CALL(_fx_M8CompilerFM4listLS1Nt10Hashset__t1S(_fx_g19Ast__all_c_inc_dirs, &v_15, 0), _fx_cleanup);
      _fx_LS lstend_1 = 0;
      _fx_LS lst_1 = v_15;
      for (; lst_1; lst_1 = lst_1->tl) {
         fx_str_t concat_str_1 = {0};
         fx_str_t* d_1 = &lst_1->hd;
         fx_str_t slit_62 = FX_MAKE_STR("-I");
         {
            const fx_str_t strs_7[] = { slit_62, *d_1 };
            FX_CALL(fx_strjoin(0, 0, 0, strs_7, 2, &concat_str_1), _fx_catch_1);
         }
         _fx_LS node_1 = 0;
         FX_CALL(_fx_cons_LS(&concat_str_1, 0, false, &node_1), _fx_catch_1);
         FX_LIST_APPEND(v_16, lstend_1, node_1);

      _fx_catch_1: ;
         FX_FREE_STR(&concat_str_1);
         FX_CHECK_EXN(_fx_cleanup);
      }
      fx_str_t slit_63 = FX_MAKE_STR(" ");
      FX_CALL(_fx_M8CompilerFM4joinS2SLS(&slit_63, v_16, &incdirs_1, 0), _fx_cleanup);
      ...
      fx_str_t slit_69 = FX_MAKE_STR(" -I");
      {
         const fx_str_t strs_8[] = { slit_65, v_17, v_18, slit_66, v_19, slit_67, v_20, slit_68, v_21, slit_69, v_22 };
         FX_CALL(fx_strjoin(0, 0, 0, strs_8, 11, &cflags_3), _fx_cleanup);
      }
      if (FX_STR_LENGTH(libpath_1) != 0) {
         FX_CALL(_fx_M8CompilerFM6stringS1S(&runtime_lib_path_0, &v_24, 0), _fx_cleanup);
         FX_CALL(_fx_M8CompilerFM6stringS1S(&libpath_1, &v_25, 0), _fx_cleanup);
         fx_str_t slit_70 = FX_MAKE_STR("-L");
         fx_str_t slit_71 = FX_MAKE_STR("/");
         fx_str_t slit_72 = FX_MAKE_STR(" ");
         {
            const fx_str_t strs_9[] = { slit_70, v_24, slit_71, v_25, slit_72 };
            FX_CALL(fx_strjoin(0, 0, 0, strs_9, 5, &v_23), _fx_cleanup);
         }
      }
      else {
         fx_str_t slit_73 = FX_MAKE_STR(""); fx_copy_str(&slit_73, &v_23);
      }
      FX_CALL(_fx_M8CompilerFM6stringS1S(&clibs_1, &v_26, 0), _fx_cleanup);
      fx_str_t slit_74 = FX_MAKE_STR("-lm ");
      {
         const fx_str_t strs_10[] = { v_23, slit_74, v_26 };
         FX_CALL(fx_strjoin(0, 0, 0, strs_10, 3, &clibs_2), _fx_cleanup);
      }
      fx_str_t slit_75 = FX_MAKE_STR(".o");
      fx_str_t slit_76 = FX_MAKE_STR("-c -o ");
      fx_str_t slit_77 = FX_MAKE_STR("-o ");
      fx_str_t slit_78 = FX_MAKE_STR("-l");
      _fx_make_Ta9S(&os_0, &c_comp_0, &cpp_comp_0, &slit_75, &slit_76, &slit_77, &slit_78, &cflags_3, &clibs_2, &v_0);
   }
   ...
   fx_str_t slit_79 = FX_MAKE_STR("FICUS_CFLAGS");
   FX_CALL(_fx_M3SysFM6getenvS1S(&slit_79, &custom_cflags_0, 0), _fx_cleanup);
   fx_copy_str(&_fx_g12Options__opt.cflags, &v_27);
   if (FX_STR_LENGTH(v_27) == 0) {
      fx_copy_str(&custom_cflags_0, &custom_cflags_1);
   }
   else {
      fx_copy_str(&_fx_g12Options__opt.cflags, &v_28);
      fx_str_t slit_80 = FX_MAKE_STR(" ");
      {
         const fx_str_t strs_11[] = { v_28, slit_80, custom_cflags_0 };
         FX_CALL(fx_strjoin(0, 0, 0, strs_11, 3, &custom_cflags_1), _fx_cleanup);
      }
   }
   fx_str_t slit_81 = FX_MAKE_STR(" ");
   {
      const fx_str_t strs_12[] = { cflags_4, slit_81, custom_cflags_1 };
      FX_CALL(fx_strjoin(0, 0, 0, strs_12, 3, &cflags_5), _fx_cleanup);
   }
   FX_CALL(_fx_M8CompilerFM6stringS1S(&cflags_5, &v_29, 0), _fx_cleanup);
   fx_str_t slit_82 = FX_MAKE_STR("Compiling .c/.cpp files with cflags=");
   {
      const fx_str_t strs_13[] = { slit_82, v_29 };
      FX_CALL(fx_strjoin(0, 0, 0, strs_13, 2, &v_30), _fx_cleanup);
   }
   FX_CALL(_fx_M8CompilerFM6clrmsgS2N20Compiler__msgcolor_tS(&_fx_g17Compiler__MsgBlue, &v_30, &v_31, 0), _fx_cleanup);
   FX_CALL(_fx_M3AstFM10pr_verbosev1S(&v_31, 0), _fx_cleanup);
   _fx_make_R14Ast__pragmas_t(false, 0, &v_32);
   _fx_make_R17C_form__cmodule_t(&_fx_g9Ast__noid, &runtime_impl_0, 0, false, true, false, &v_32, &runtime_pseudo_cmod_0);
   FX_CALL(_fx_cons_LR17C_form__cmodule_t(&runtime_pseudo_cmod_0, cmods_0, true, &cmods_1), _fx_cleanup);
   FX_CALL(_fx_M8CompilerFM5arrayA1R17C_form__cmodule_t1LR17C_form__cmodule_t(cmods_1, &v_33, 0), _fx_cleanup);
   int par_status_0 = 0;
   int_ ni_0 = FX_ARR_SIZE(v_33, 0);
   _fx_R17C_form__cmodule_t* ptr_v_0 = FX_PTR_1D(_fx_R17C_form__cmodule_t, v_33, 0);
   {
   ...
   for (int_ i_0 = 0; i_0 < ni_0; i_0++) {
      ...
      FX_CALL(_fx_M8FilenameFM8basenameS1S(&cmod_cname_0, &output_fname_0, 0), _fx_catch_6);
      ...
      if (is_cpp_0) {
         fx_str_t slit_83 = FX_MAKE_STR(".cpp"); _fx_make_Ta2S(&cpp_comp_1, &slit_83, &v_53);
      }
      else {
         fx_str_t slit_84 = FX_MAKE_STR(".c"); _fx_make_Ta2S(&c_comp_1, &slit_84, &v_53);
      }
      fx_copy_str(&v_53.t0, &comp_0);
      fx_copy_str(&v_53.t1, &ext_0);
      ...
      if (__pat___0.cmod_skip) {
         fx_str_t slit_85 = FX_MAKE_STR("skipped"); _fx_make_T3BBS(true, false, &slit_85, &v_54);
      }
      else if (is_runtime_0) {
         fx_str_t slit_86 = FX_MAKE_STR(""); _fx_make_T3BBS(true, true, &slit_86, &v_54);
      }
      else {
         FX_CALL(_fx_M4C_ppFM20pprint_top_to_stringS1LN15C_form__cstmt_t(cmod_ccode_0, &str_new_0, 0), _fx_catch_6);
         bool v_68 = _fx_g12Options__opt.force_rebuild;
         if (v_68) {
            fx_str_t slit_87 = FX_MAKE_STR(""); fx_copy_str(&slit_87, &str_old_0);
         }
         else {
            FX_CALL(_fx_M4FileFM9read_utf8S1S(&output_fname_c_0, &str_old_0, 0), _fx_catch_2);
         ...
         _fx_catch_2: ;
            if (fx_status < 0) {
               ...
               FX_CHECK_EXN(_fx_catch_6);
               if (res_0) {
                  fx_str_t slit_88 = FX_MAKE_STR(""); fx_copy_str(&slit_88, &str_old_0); goto _fx_endmatch_0;
               }
               FX_RETHROW(&exn_0, _fx_catch_6);
         ...
         if (v_69) {
            fx_str_t slit_89 = FX_MAKE_STR("skipped"); _fx_make_T3BBS(ok_1, false, &slit_89, &v_54);
         }
         else {
            bool well_written_0;
            FX_CALL(_fx_M4FileFM10write_utf8v2SS(&output_fname_c_0, &str_new_0, 0), _fx_catch_3);
            well_written_0 = true;
         ...
         _fx_catch_3: ;
            if (fx_status < 0) {
               ...
               FX_RETHROW(&exn_1, _fx_catch_6);

            _fx_endmatch_1: ;
               FX_CHECK_EXN(_fx_catch_6);
            }
            if (well_written_0) {
               fx_str_t slit_90 = FX_MAKE_STR(""); fx_copy_str(&slit_90, &v_55);
            }
            else {
               FX_CALL(_fx_M8CompilerFM6stringS1S(&output_fname_c_0, &v_56, 0), _fx_catch_6);
               fx_str_t slit_91 = FX_MAKE_STR("failed to write ");
               {
                  const fx_str_t strs_15[] = { slit_91, v_56 };
                  FX_CALL(fx_strjoin(0, 0, 0, strs_15, 2, &v_57), _fx_catch_6);
               }
               FX_CALL(_fx_M8CompilerFM6clrmsgS2N20Compiler__msgcolor_tS(&_fx_g16Compiler__MsgRed, &v_57, &v_55, 0),
                  _fx_catch_6);
            }
            _fx_make_T3BBS(well_written_0, well_written_0, &v_55, &v_54);
         }
      }
      bool ok_j_0 = v_54.t0;
      bool reprocess_0 = v_54.t1;
      fx_copy_str(&v_54.t2, &status_j_0);
      if (is_runtime_0) {
         fx_str_t slit_92 = FX_MAKE_STR(".c");
         {
            const fx_str_t strs_16[] = { runtime_impl_0, slit_92 };
            FX_CALL(fx_strjoin(0, 0, 0, strs_16, 2, &c_filename_0), _fx_catch_6);
         }
      }
      else {
      ...
      if (v_70) {
         FX_CALL(_fx_M8CompilerFM6stringS1S(&comp_0, &v_59, 0), _fx_catch_6);
         FX_CALL(_fx_M8CompilerFM6stringS1S(&cflags_5, &v_60, 0), _fx_catch_6);
         FX_CALL(_fx_M8CompilerFM6stringS1S(&obj_opt_0, &v_61, 0), _fx_catch_6);
         FX_CALL(_fx_M8CompilerFM6stringS1S(&obj_filename_0, &v_62, 0), _fx_catch_6);
         FX_CALL(_fx_M8CompilerFM6stringS1S(&c_filename_0, &v_63, 0), _fx_catch_6);
         fx_str_t slit_93 = FX_MAKE_STR(" ");
         fx_str_t slit_94 = FX_MAKE_STR(" ");
         fx_str_t slit_95 = FX_MAKE_STR(" ");
         {
            const fx_str_t strs_18[] = { v_59, slit_93, v_60, slit_94, v_61, v_62, slit_95, v_63 };
         ...
         if (v_72) {
            ...
            for (;;) {
               fx_str_t str_0 = {0};
               FX_CALL(_fx_M4FileFM6readlnS1RM1t(&p_0, &str_0, 0), _fx_catch_4);
               if (FX_STR_LENGTH(str_0) == 0) {
                  FX_BREAK(_fx_catch_4);
               }
               lineno_0 = lineno_0 + 1;
               if (lineno_0 > 1) {
                  FX_CALL(_fx_M8CompilerFM5printv1S(&str_0, 0), _fx_catch_4);
               }
         ...
         if (result_0) {
            ...
            FX_CALL(_fx_M8CompilerFM6clrmsgS2N20Compiler__msgcolor_tS(&_fx_g18Compiler__MsgGreen, &slit_98, &status_0, 0),
               _fx_catch_6);
         }
         else {
            fx_str_t slit_99 = FX_MAKE_STR("fail");
            FX_CALL(_fx_M8CompilerFM6clrmsgS2N20Compiler__msgcolor_tS(&_fx_g16Compiler__MsgRed, &slit_99, &status_0, 0),
               _fx_catch_6);
         }
         _fx_make_T3BBS(result_0, true, &status_0, &v_58);
      }
      else {
         _fx_make_T3BBS(ok_j_0, false, &status_j_0, &v_58);
      }
      bool ok_j_1 = v_58.t0;
      bool recompiled_0 = v_58.t1;
      fx_copy_str(&v_58.t2, &status_j_1);
      FX_CALL(_fx_M8CompilerFM6stringS1S(&c_filename_0, &v_64, 0), _fx_catch_6);
      FX_CALL(_fx_M8CompilerFM6stringS1S(&status_j_1, &v_65, 0), _fx_catch_6);
      fx_str_t slit_100 = FX_MAKE_STR("CC ");
      fx_str_t slit_101 = FX_MAKE_STR(": ");
      {
         const fx_str_t strs_19[] = { slit_100, v_64, slit_101, v_65 };
         FX_CALL(fx_strjoin(0, 0, 0, strs_19, 4, &v_66), _fx_catch_6);
      }
      FX_CALL(_fx_M3AstFM10pr_verbosev1S(&v_66, 0), _fx_catch_6);
      _fx_LS lstend_2 = 0;
      ...
      for (; lst_2; lst_2 = lst_2->tl) {
         ...
         FX_LIST_APPEND(v_67, lstend_2, node_2);

      _fx_catch_5: ;
         FX_CHECK_EXN(_fx_catch_6);
      }
      FX_CALL(_fx_M8CompilerFM3revLS1LS(v_67, &clibs_5, 0), _fx_catch_6);
   ...
   bool any_cpp_0 = false;
   bool any_recompiled_0 = false;
   bool ok_2 = ok_1;
   ...
   for (int_ i_2 = 0; i_2 < ni_1; i_2++) {
      ...
      any_cpp_0 = (bool)(any_cpp_0 | __pat___2.t0);
      any_recompiled_0 = (bool)(any_recompiled_0 | __pat___2.t1);
      FX_CALL(_fx_M8CompilerFM7__add__LS2LSLS(clibs_j_0, all_clibs_0, &v_75, 0), _fx_catch_7);
      _fx_free_LS(&all_clibs_0);
      FX_COPY_PTR(v_75, &all_clibs_0);
      ok_2 = (bool)(ok_2 & __pat___2.t3);
      FX_CALL(_fx_cons_LS(&obj_0, objs_0, true, &v_76), _fx_catch_7);
      _fx_free_LS(&objs_0);
      FX_COPY_PTR(v_76, &objs_0);
   ...
   if (t_0) {
      fx_copy_str(&_fx_g12Options__opt.app_filename, &v_34); FX_CALL(_fx_M8FilenameFM6existsB1S(&v_34, &v_77, 0), _fx_cleanup);
   }
   else {
      v_77 = false;
   }
   if (v_77) {
      fx_copy_str(&_fx_g12Options__opt.app_filename, &v_35);
      FX_CALL(_fx_M8CompilerFM6stringS1S(&v_35, &v_36, 0), _fx_cleanup);
      fx_str_t slit_102 = FX_MAKE_STR(" is up-to-date\n");
      {
         const fx_str_t strs_20[] = { v_36, slit_102 };
         FX_CALL(fx_strjoin(0, 0, 0, strs_20, 2, &v_37), _fx_cleanup);
      }
      ...
      *fx_result = ok_2;
      ...
      fx_str_t slit_103 = FX_MAKE_STR("FICUS_LINK_LIBRARIES");
      FX_CALL(_fx_M3SysFM6getenvS1S(&slit_103, &custom_clibs_0, 0), _fx_cleanup);
      fx_copy_str(&_fx_g12Options__opt.clibs, &v_38);
      if (FX_STR_LENGTH(v_38) == 0) {
         fx_copy_str(&custom_clibs_0, &custom_clibs_1);
      }
      else {
         fx_copy_str(&_fx_g12Options__opt.clibs, &v_39);
         fx_str_t slit_104 = FX_MAKE_STR(" ");
         {
            const fx_str_t strs_21[] = { custom_clibs_0, slit_104, v_39 };
            FX_CALL(fx_strjoin(0, 0, 0, strs_21, 3, &custom_clibs_1), _fx_cleanup);
         }
      }
      if (all_clibs_0 == 0) {
         ...
         FX_CALL(_fx_M8CompilerFM3revLS1LS(all_clibs_0, &v_40, 0), _fx_cleanup);
         _fx_LS lstend_3 = 0;
         _fx_LS lst_3 = v_40;
         for (; lst_3; lst_3 = lst_3->tl) {
            fx_str_t concat_str_2 = {0};
            fx_str_t* l_0 = &lst_3->hd;
            {
               const fx_str_t strs_22[] = { link_lib_opt_0, *l_0 };
               FX_CALL(fx_strjoin(0, 0, 0, strs_22, 2, &concat_str_2), _fx_catch_8);
            }
            _fx_LS node_3 = 0;
            FX_CALL(_fx_cons_LS(&concat_str_2, 0, false, &node_3), _fx_catch_8);
            FX_LIST_APPEND(v_41, lstend_3, node_3);

         _fx_catch_8: ;
            FX_FREE_STR(&concat_str_2);
            FX_CHECK_EXN(_fx_cleanup);
         }
         fx_str_t slit_105 = FX_MAKE_STR(" ");
         FX_CALL(_fx_M8CompilerFM4joinS2SLS(&slit_105, v_41, &v_42, 0), _fx_cleanup);
         fx_str_t slit_106 = FX_MAKE_STR(" ");
         {
            const fx_str_t strs_23[] = { custom_clibs_1, slit_106, v_42 };
            FX_CALL(fx_strjoin(0, 0, 0, strs_23, 3, &custom_clibs_2), _fx_cleanup);
         }
      }
      fx_str_t slit_107 = FX_MAKE_STR(" ");
      {
         const fx_str_t strs_24[] = { clibs_3, slit_107, custom_clibs_2 };
         FX_CALL(fx_strjoin(0, 0, 0, strs_24, 3, &clibs_4), _fx_cleanup);
      }
      FX_CALL(_fx_M8CompilerFM6stringS1S(&clibs_4, &v_43, 0), _fx_cleanup);
      fx_str_t slit_108 = FX_MAKE_STR("Linking the app with flags=");
      {
         const fx_str_t strs_25[] = { slit_108, v_43 };
         FX_CALL(fx_strjoin(0, 0, 0, strs_25, 2, &v_44), _fx_cleanup);
      }
      FX_CALL(_fx_M3AstFM10pr_verbosev1S(&v_44, 0), _fx_cleanup);
      if (any_cpp_0) {
         fx_copy_str(&cpp_comp_1, &v_45);
      }
      else {
         fx_copy_str(&c_comp_1, &v_45);
      }
      fx_copy_str(&_fx_g12Options__opt.app_filename, &v_46);
      fx_str_t slit_109 = FX_MAKE_STR(" ");
      {
         const fx_str_t strs_26[] = { v_45, slit_109, appname_opt_0, v_46 };
         FX_CALL(fx_strjoin(0, 0, 0, strs_26, 4, &cmd_0), _fx_cleanup);
      }
      fx_str_t slit_110 = FX_MAKE_STR(" ");
      FX_CALL(_fx_M8CompilerFM4joinS2SLS(&slit_110, objs_0, &v_47, 0), _fx_cleanup);
      fx_str_t slit_111 = FX_MAKE_STR(" ");
      fx_str_t slit_112 = FX_MAKE_STR(" ");
      {
         const fx_str_t strs_27[] = { cmd_0, slit_111, v_47, slit_112, clibs_4 };
         FX_CALL(fx_strjoin(0, 0, 0, strs_27, 5, &cmd_1), _fx_cleanup);
      }
      int_ v_78;
      FX_CALL(_fx_M3SysFM7commandi1S(&cmd_1, &v_78, 0), _fx_cleanup);
      *fx_result = v_78 == 0;
   }
...
_fx_cleanup: ;
   ...
   FX_FREE_STR(&v_30);
   FX_FREE_STR(&v_31);
   _fx_free_R14Ast__pragmas_t(&v_32);
...
FX_EXTERN_C int _fx_M8CompilerFM22print_all_compile_errsv0(void* fx_fv)
{
   ...
   for (; lst_0; lst_0 = lst_0->tl) {
      ...
      FX_CALL(_fx_cons_LE(a_0, res_0, true, &v_9), _fx_catch_0);
      _fx_free_LE(&res_0);
   ...
   for (; lst_1; lst_1 = lst_1->tl) {
      ...
      FX_CHECK_EXN(_fx_catch_3);
      int_ v_11 = _fx_M6StringFM4findi2SC(&msg_0, (char_)10, 0);
      if (v_11 == -1) {
         fx_copy_str(&msg_0, &key_0);
      }
      else {
         FX_CALL(fx_substr(&msg_0, 0, v_11, 1, 1, &key_0), _fx_catch_2);  _fx_catch_2: ;
      }
      FX_CHECK_EXN(_fx_catch_3);
      bool v_12;
      if (FX_STR_LENGTH(key_0) != 0) {
         uint64_t v_13 = _fx_F4hashq1S(&key_0, 0);
         _fx_Ta2i v_14;
         FX_CALL(_fx_M8CompilerFM9find_idx_Ta2i3Nt10Hashset__t1SSq(seen_0, &key_0, v_13 & 9223372036854775807ULL, &v_14, 0),
            _fx_catch_3);
         v_12 = v_14.t1 >= 0;
      }
      else {
      ...
      if (v_12) {
         FX_COPY_PTR(acc_0, &v_10);
      }
      else {
         if (FX_STR_LENGTH(key_0) != 0) {
            uint64_t v_15 = _fx_F4hashq1S(&key_0, 0);
            FX_CALL(_fx_M8CompilerFM4add_v3Nt10Hashset__t1SSq(seen_0, &key_0, v_15 & 9223372036854775807ULL, 0), _fx_catch_3);
         }
         FX_CALL(_fx_cons_LE(e_0, acc_0, true, &v_10), _fx_catch_3);
      }
      _fx_free_LE(&acc_0);
      FX_COPY_PTR(v_10, &acc_0);
   ...
   FX_COPY_PTR(acc_0, &uniq_0);
   _fx_LE lst_2 = uniq_0;
   for (; lst_2; lst_2 = lst_2->tl) {
      _fx_LE v_16 = 0;
      fx_exn_t* a_1 = &lst_2->hd;
      FX_CALL(_fx_cons_LE(a_1, res_1, true, &v_16), _fx_catch_4);
      _fx_free_LE(&res_1);
      FX_COPY_PTR(v_16, &res_1);
      ...
      if (v_17 != 0) {
         if (v_17->tl == 0) {
            ...
            if (b_0->tag == _FX_EXN_E17Ast__CompileError) {
               ...
               _fx_Ta3i tup_1 = { 1000000000, 0, 0 }; v_19 = tup_1;
            }
            FX_CHECK_EXN(_fx_catch_5);
            int_ ma_0 = v_19.t0;
            int_ la_0 = v_19.t1;
            ...
            if (a_2->tag == _FX_EXN_E17Ast__CompileError) {
               ...
               _fx_Ta3i tup_3 = { 1000000000, 0, 0 }; v_20 = tup_3;
            }
            FX_CHECK_EXN(_fx_catch_5);
            int_ mb_0 = v_20.t0;
            int_ lb_0 = v_20.t1;
            ...
            if (t_0) {
               FX_CALL(_fx_cons_LE(a_2, 0, true, &v_18), _fx_catch_5);
               FX_CALL(_fx_cons_LE(b_0, v_18, true, &sorted_0), _fx_catch_5);
            }
            else {
...
_fx_endmatch_0: ;
   ...
   if (nerrs_0 != 0) {
      ...
      bool v_21;
      FX_CALL(_fx_M3AstFM19diag_format_is_jsonB0(&v_21, 0), _fx_cleanup);
      if (!v_21) {
         if (nerrs_0 > cap_0) {
...
FX_EXTERN_C int _fx_M8CompilerFM11process_allB1S(fx_str_t* fname0_0, bool* fx_result, void* fx_fv)
{
   ...
   bool v_28 = _fx_g12Options__opt.print_ast0;
   if (v_28) {
   ...
   for (; lst_1; lst_1 = lst_1->tl) {
      ...
      FX_CALL(_fx_M3AstFM15get_module_nameRM4id_t1i(m_idx_0, &v_29, 0), _fx_catch_2);
      FX_CALL(_fx_M3AstFM2ppS1RM4id_t(&v_29, &res_0, 0), _fx_catch_2);
      _fx_LS node_1 = 0;
   ...
   if (_fx_g21Compiler__iscolorterm) {
      ...
      fx_str_t slit_6 = FX_MAKE_STR("Parsing complete"); fx_copy_str(&slit_6, &parsing_complete_0);
   }
   ...
   if (ok_1) {
      ...
      bool v_30 = _fx_g12Options__opt.print_ast;
      if (v_30) {
   ...
   if (ok_2) {
      ...
      bool v_31 = _fx_g12Options__opt.print_k0;
      if (v_31) {
   ...
   if (_fx_g12Options__opt.print_k) {
      ...
      v_32 = _fx_g12Options__opt.gen_c;
   }
   if (v_32) {
      if (ok_2) {
         if (_fx_g21Compiler__iscolorterm) {
         ...
         FX_CALL(_fx_M8CompilerFM14k_optimize_allT2LR17K_form__kmodule_tB1LR17K_form__kmodule_t(kmods_1, &v_14, 0),
            _fx_catch_6);
      }
      else {
      ...
      _fx_make_T2LR17K_form__kmodule_tB(kmods_1, ok_2, &v_14);
   }
   ...
   if (ok_3) {
      ...
      bool v_33 = _fx_g12Options__opt.print_k;
      if (v_33) {
   ...
   bool v_34 = _fx_g12Options__opt.gen_c;
   bool ok_4;
   if (!v_34) {
      ok_4 = ok_3;
   }
      ...
      if (ok_5) {
         if (_fx_g12Options__opt.make_app) {
            ...
            v_35 = _fx_g12Options__opt.run_app;
         }
      }
      else {
         v_35 = false;
      ...
      bool v_36;
      if (ok_6) {
         v_36 = _fx_g12Options__opt.run_app;
      }
      else {
         v_36 = false;
      }
      if (v_36) {
         ...
         FX_CALL(_fx_cons_LS(&appname_1, v_21, true, &v_22), _fx_catch_6);
         fx_str_t slit_21 = FX_MAKE_STR(" ");
         FX_CALL(_fx_F4joinS2SLS(&slit_21, v_22, &cmd_0, 0), _fx_catch_6);
         int_ v_37;
         FX_CALL(_fx_M3SysFM7commandi1S(&cmd_0, &v_37, 0), _fx_catch_6);
         ok_4 = v_37 == 0;
      }
      else {
         ok_4 = ok_6;
   ...
   bool v_38;
   if (nwarns_0 != 0) {
      bool v_39; FX_CALL(_fx_M3AstFM19diag_format_is_jsonB0(&v_39, 0), _fx_catch_6); v_38 = !v_39;
   }
   else {
      v_38 = false;
   }
   if (v_38) {
      ...
      bool v_40 = _fx_g12Options__opt.Werror;
      if (v_40) {
         FX_CALL(_fx_F6stringS1i(nwarns_0, &v_23, 0), _fx_catch_6);
         ...
         {
            const fx_str_t strs_2[] = { slit_24, v_23, slit_25, plural_0, slit_26 };
            FX_CALL(fx_strjoin(0, 0, 0, strs_2, 5, &v_24), _fx_catch_6);
         }
         ...
         FX_CALL(_fx_F6stringS1i(nwarns_0, &v_25, 0), _fx_catch_6);
         fx_str_t slit_28 = FX_MAKE_STR("\n");
         fx_str_t slit_29 = FX_MAKE_STR(" ");
         fx_str_t slit_30 = FX_MAKE_STR(" generated.");
         {
            const fx_str_t strs_3[] = { slit_28, v_25, slit_29, plural_0, slit_30 };
            FX_CALL(fx_strjoin(0, 0, 0, strs_3, 5, &v_26), _fx_catch_6);
         }
         _fx_F12print_stringv1S(&v_26, 0);
   ...
   if (ok_4) {
      ...
      if (_fx_g12Options__opt.Werror) {
         v_41 = _fx_g22Ast__all_compile_warns > 0;
      }
      else {
         v_41 = false;
      }
   ...
   if (fx_status < 0) {
      ...
      if (tag_0 == _FX_EXN_E4Fail) {
         ...
         fx_str_t* msg_0 = &FX_EXN_DATA(_fx_E4Fail_data_t, exn_0.data);
         {
            ...
            FX_CALL(fx_strjoin(0, 0, 0, strs_4, 3, &v_42), _fx_catch_7);
         }
      ...
      _fx_catch_7: ;
         ...
         fx_str_t v_43 = {0};
         fx_str_t v_44 = {0};
         FX_CALL(_fx_F6stringS1E(&exn_0, &v_43, 0), _fx_catch_9);
         fx_str_t slit_34 =
            FX_MAKE_STR("\n"
               U"\n");
         ...
         {
            const fx_str_t strs_5[] = { slit_34, _fx_g15Compiler__error, slit_35, v_43, slit_36 };
            FX_CALL(fx_strjoin(0, 0, 0, strs_5, 5, &v_44), _fx_catch_9);
         }
