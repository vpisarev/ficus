...
int_ _fx_g14File__SEEK_SET =  (int)SEEK_SET ;
int_ _fx_g15File__SEEK_CURR =  (int)SEEK_CUR ;
int_ _fx_g14File__SEEK_END =  (int)SEEK_END ;
_fx_R7File__t _fx_g12File__stdout = {};
FX_EXTERN_C int _fx_M4FileFM13get_stdstreamRM1t1i(int_ i,
                                                  _fx_R7File__t* fx_result,
                                                  void* fx_fv)
{
   if(i != 0 && i != 1 && i != 2)
