...
FX_EXTERN_C int _fx_M3AstFM15compile_warningv2RM5loc_tS(struct _fx_R10Ast__loc_t* loc, fx_str_t* msg, void* fx_fv);
   ...
   void* fx_fv)
{
   ...
   for (int_ j_0 = 0; j_0 < tabsz_0; j_0++) {
      ...
      if (FX_PTR_1D(_fx_Rt24Hashset__hashset_entry_t1R9Ast__id_t, table_0, j_0)->hv < 9223372036854775808ULL) {
         ...
         _fx_Ta2i v_11;
         FX_CALL(
            _fx_M15K_remove_unusedFM9find_idx_Ta2i3Nt10Hashset__t1R9Ast__id_tR9Ast__id_tq(b_0, &v_10,
      ...
      if (v_9) {
         ...
         FX_CHKIDX(FX_CHKIDX1(table_0, 0, j_0), _fx_catch_0);
         FX_CALL(
            _fx_M15K_remove_unusedFM4add_v3Nt10Hashset__t1R9Ast__id_tR9Ast__id_tq(self_0, &v_12,
   ...
   void* fx_fv)
{
   ...
   _fx_catch_2: ;
      ...
      if (v_18.t1 >= 0) {
         ...
         if (t_4) {
            bool v_22; FX_CALL(_fx_M3AstFM15is_global_scopeB1LN12Ast__scope_t(kf_scope_0, &v_22, 0), _fx_catch_3); v_21 = !v_22;
         }
         else {
            v_21 = false;
         }
         ...
         if (v_34 != 0) {
            ...
            if (FX_REC_VARIANT_TAG(v_35) == 31) {
               ...
               if (FX_REC_VARIANT_TAG(v_36) == 5) {
                  ...
                  if (v_37->tag == 1) {
                     bool res_2;
                     FX_CALL(_fx_M3AstFM6__eq__B2RM4id_tRM4id_t(&vcase_3->t0, &v_37->u.AtomId, &res_2, 0), _fx_catch_12);
                     if (res_2) {
