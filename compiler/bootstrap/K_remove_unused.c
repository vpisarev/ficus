   ...
   void* fx_fv)
{
   ...
   _fx_make_R22K_form__k_fold_callb_t(v_1, v_2, _fx_g7None31_, &pure_callb_0);
   ...
   void* fx_fv)
{
   ...
   for (; lst_0; lst_0 = lst_0->tl) {
      ...
      _fx_make_R22K_form__k_fold_callb_t(v_3, v_4, _fx_g7None31_, &callb_0);
   ...
   _fx_make_R17K_form__k_callb_t(v_1, v_2, _fx_g7None33_, &remove_callb_0);
               ...
               if (t_1) {
                  ...
                  for (;;) {
                     ...
                     _fx_catch_1: ;
                        ...
                        res_1 = _fx_g7None47_; FX_BREAK(_fx_catch_2);  _fx_catch_2: ;
                     }
                     FX_CHECK_EXN(_fx_catch_3);
