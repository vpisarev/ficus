                             ...
                             int ntasks)
{
    ...
    bool is3x3 = conv->Hk == 3 && conv->Wk == 3;
                    ...
                    if (is3x3) {
                        if (dy0 == 3) {
                            for (; x0 < x1; x0 += vec_nlanes) {
                                ...
                                s0 = vmulq_f32(vminq_f32(s0, vmaxval), vbslq_f32(vcltq_f32(s0, z), valpha, one));
                                s1 = vmulq_f32(vminq_f32(s1, vmaxval), vbslq_f32(vcltq_f32(s1, z), valpha, one));
                                s2 = vmulq_f32(vminq_f32(s2, vmaxval), vbslq_f32(vcltq_f32(s2, z), valpha, one));
